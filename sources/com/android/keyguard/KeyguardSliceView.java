...
public class KeyguardSliceView extends LinearLayout implements View.OnClickListener, Observer<Slice>, TunerService.Tunable, ConfigurationController.ConfigurationListener {
    ...
    public KeyguardSliceView(Context context, AttributeSet attributeSet, ActivityStarter activityStarter, ConfigurationController configurationController) {
        ...
        this.mRowPadding = context.getResources().getDimensionPixelSize(C0005R$dimen.subtitle_clock_padding);
        this.mRowWithHeaderPadding = context.getResources().getDimensionPixelSize(C0005R$dimen.header_subtitle_padding);
    ...
    public void onFinishInflate() {
        ...
        this.mTitle = (TextView) findViewById(C0007R$id.title);
        this.mRow = (Row) findViewById(C0007R$id.row);
        ...
        this.mRowTextSize = (float) ((LinearLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.widget_label_font_size);
    ...
    private void showSlice() {
        ...
        while (i4 < size) {
            ...
            if (keyguardSliceButton == null) {
                keyguardSliceButton = new KeyguardSliceButton(((LinearLayout) this).mContext);
    ...
    public void setupUri(String str) {
        ...
        this.mLiveData = SliceLiveData.fromUri(((LinearLayout) this).mContext, this.mKeyguardSliceUri);
        if (z) {
            this.mLiveData.observeForever(this);
        }
    }
    ...
    public static class KeyguardSliceButton extends Button implements ConfigurationController.ConfigurationListener {
        private static int sStyleId = C0015R$style.TextAppearance_Keyguard_Secondary;
        ...
        private void updatePadding() {
            ...
            setCompoundDrawablePadding((int) ((Button) this).mContext.getResources().getDimension(C0005R$dimen.widget_icon_padding));
        }
