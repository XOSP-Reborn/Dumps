...
public class ClockLayout extends FrameLayout {
    ...
    private void positionChildren() {
        ...
        float lerp2 = MathUtils.lerp(0.0f, (float) (BurnInHelperKt.getBurnInOffset(this.mBurnInPreventionOffsetY * 2, false) - this.mBurnInPreventionOffsetY), this.mDarkAmount);
