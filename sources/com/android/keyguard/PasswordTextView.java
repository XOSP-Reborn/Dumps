...
import com.sonymobile.keyguard.pin.PasswordEntryListener;
...
public class PasswordTextView extends View {
    ...
    private PasswordEntryListener mPasswordEntryListener;
    ...
    public PasswordTextView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        try {
            ...
            this.mDrawPaint.setTypeface(Typeface.create(context.getString(17039771), 0));
    ...
    public void append(char c) {
        ...
        if (!this.mContentLocked) {
            ...
            PasswordEntryListener passwordEntryListener = this.mPasswordEntryListener;
            if (passwordEntryListener != null) {
                passwordEntryListener.onPasswordLengthIncreased(length);
            }
            if (length > 1) {
    ...
    public final void setPinEntryListener(PasswordEntryListener passwordEntryListener) {
        this.mPasswordEntryListener = passwordEntryListener;
    }
    ...
    public void reset(boolean z, boolean z2) {
        if (!this.mContentLocked) {
            ...
            while (i3 < size) {
                CharState charState = this.mTextChars.get(i3);
                if (z) {
                    charState.startRemoveAnimation(Math.min(((long) (i3 <= i2 ? i3 * 2 : i - (((i3 - i2) - 1) * 2))) * 40, 200L), Math.min(((long) i) * 40, 200L) + 160);
