...
public class PowerUI extends SystemUI {
    ...
    public void updateBatteryWarningLevels() {
        int integer = this.mContext.getResources().getInteger(17694764);
        int integer2 = this.mContext.getResources().getInteger(17694830);
        if (integer2 < integer) {
            integer2 = integer;
        }
    ...
    public synchronized void doSkinThermalEventListenerRegistration() {
        ...
        boolean z3 = true;
        this.mEnableSkinTemperatureWarning = Settings.Global.getInt(this.mContext.getContentResolver(), "show_temperature_warning", this.mContext.getResources().getInteger(C0008R$integer.config_showTemperatureWarning)) != 0;
    ...
    public synchronized void doUsbThermalEventListenerRegistration() {
        ...
        boolean z3 = true;
        this.mEnableUsbTemperatureAlarm = Settings.Global.getInt(this.mContext.getContentResolver(), "show_usb_temperature_alarm", this.mContext.getResources().getInteger(C0008R$integer.config_showUsbPortAlarm)) != 0;
