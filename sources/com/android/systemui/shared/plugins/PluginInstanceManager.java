...
public class PluginInstanceManager<T extends Plugin> {
    ...
    public class PluginHandler extends Handler {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v2, resolved type: com.android.systemui.plugins.PluginListener */
        /* JADX WARN: Multi-variable type inference failed */
        public void handleMessage(Message message) {
            int i = message.what;
            if (i == 1) {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r14v0, resolved type: com.android.systemui.shared.plugins.PluginInstanceManager$PluginHandler */
        /* JADX WARN: Multi-variable type inference failed */
