...
public class VolumeDialogControllerImpl implements VolumeDialogController, Dumpable {
    ...
    static {
        STREAMS.put(4, Integer.valueOf(C0014R$string.stream_alarm));
        STREAMS.put(6, Integer.valueOf(C0014R$string.stream_bluetooth_sco));
        STREAMS.put(8, Integer.valueOf(C0014R$string.stream_dtmf));
        STREAMS.put(3, Integer.valueOf(C0014R$string.stream_music));
        STREAMS.put(10, Integer.valueOf(C0014R$string.stream_accessibility));
        STREAMS.put(5, Integer.valueOf(C0014R$string.stream_notification));
        STREAMS.put(2, Integer.valueOf(C0014R$string.stream_ring));
        STREAMS.put(1, Integer.valueOf(C0014R$string.stream_system));
        STREAMS.put(7, Integer.valueOf(C0014R$string.stream_system_enforced));
        STREAMS.put(9, Integer.valueOf(C0014R$string.stream_tts));
        STREAMS.put(0, Integer.valueOf(C0014R$string.stream_voice_call));
        STREAMS.put(11, Integer.valueOf(C0014R$string.haptics_panel_title));
    }
    ...
    public boolean areCaptionsEnabled() {
        return Settings.Secure.getInt(this.mContext.getContentResolver(), "odi_captions_enabled", 0) == 1;
    }

    @Override // com.android.systemui.plugins.VolumeDialogController
    public void setCaptionsEnabled(boolean z) {
        Settings.Secure.putInt(this.mContext.getContentResolver(), "odi_captions_enabled", z ? 1 : 0);
    }
    ...
    public void vibrate(VibrationEffect vibrationEffect) {
        ...
        if (this.mVibrator.hasAmplitudeControl()) {
            this.mVibrator.vibrate(VibrationEffect.get(1006));
            return;
        }
    ...
    private void onGetCaptionsComponentStateW(boolean z) {
        try {
            String string = this.mContext.getString(17039745);
    ...
    public boolean onVolumeChangedW(int i, int i2) {
        ...
        boolean z3 = (i2 & 128) != 0;
        boolean isMediaVibrationActivated = Util.isMediaVibrationActivated(getAudioManager());
        ...
        this.mCallbacks.onMediaVibrateModeChanged(isMediaVibrationActivated);
    ...
    public class C implements VolumeDialogController.Callbacks {
        ...
        @Override // com.android.systemui.plugins.VolumeDialogController.Callbacks
        public void onMediaVibrateModeChanged(final boolean z) {
            for (final Map.Entry<VolumeDialogController.Callbacks, Handler> entry : this.mCallbackMap.entrySet()) {
                entry.getValue().post(new Runnable() {
                    /* class com.android.systemui.volume.VolumeDialogControllerImpl.C.AnonymousClass11 */

                    public void run() {
                        ((VolumeDialogController.Callbacks) entry.getKey()).onMediaVibrateModeChanged(z);
                    }
                });
            }
        }
