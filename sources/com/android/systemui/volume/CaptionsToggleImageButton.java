...
public class CaptionsToggleImageButton extends AlphaOptimizedImageButton {
    ...
    public CaptionsToggleImageButton(Context context, AttributeSet attributeSet) {
        ...
        setContentDescription(getContext().getString(C0014R$string.volume_odi_captions_content_description));
    }
    ...
    public Runnable setCaptionsEnabled(boolean z) {
        ...
        if (this.mCaptionsEnabled) {
            str = getContext().getString(C0014R$string.volume_odi_captions_hint_disable);
        } else {
            str = getContext().getString(C0014R$string.volume_odi_captions_hint_enable);
        }
