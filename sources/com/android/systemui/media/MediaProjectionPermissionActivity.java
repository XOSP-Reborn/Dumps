        ...
        try {
            ...
            try {
                ...
                if (Utils.isHeadlessRemoteDisplayProvider(packageManager, this.mPackageName)) {
                    str = getString(C0014R$string.media_projection_dialog_service_text);
                } else {
                    ...
                    String string = getString(C0014R$string.media_projection_dialog_text, new Object[]{unicodeWrap});
                ...
                String string2 = getString(C0014R$string.media_projection_dialog_title);
                View inflate = View.inflate(this, C0010R$layout.media_projection_dialog_title, null);
                ((TextView) inflate.findViewById(C0007R$id.dialog_title)).setText(string2);
                this.mDialog = new AlertDialog.Builder(this).setCustomTitle(inflate).setMessage(str).setPositiveButton(C0014R$string.media_projection_action_text, this).setNegativeButton(17039360, this).setOnCancelListener(this).create();
                this.mDialog.create();
