...
public final class Dependency_MembersInjector implements MembersInjector<Dependency> {
    ...
    public static void injectMNavigationBarLockController(Dependency dependency, Lazy<NavigationBarLockController> lazy) {
        dependency.mNavigationBarLockController = lazy;
    }
    ...
    public static void injectMAmbientPulseManager(Dependency dependency, Lazy<AmbientPulseManager> lazy) {
        dependency.mAmbientPulseManager = lazy;
    }
    ...
    public static void injectMLockscreenAlbumArtController(Dependency dependency, Lazy<LockscreenAlbumArtController> lazy) {
        dependency.mLockscreenAlbumArtController = lazy;
    }

    public static void injectMLockscreenTransparentScrimController(Dependency dependency, Lazy<LockscreenTransparentScrimController> lazy) {
        dependency.mLockscreenTransparentScrimController = lazy;
    }

    public static void injectMLockscreenClockController(Dependency dependency, Lazy<LockscreenClockController> lazy) {
        dependency.mLockscreenClockController = lazy;
    }

    public static void injectMLockscreenLoopsController(Dependency dependency, Lazy<LockscreenLoopsController> lazy) {
        dependency.mLockscreenLoopsController = lazy;
    }

    public static void injectMLockscreenAmbientDisplayController(Dependency dependency, Lazy<LockscreenAmbientDisplayController> lazy) {
        dependency.mLockscreenAmbientDisplayController = lazy;
    }

    public static void injectMLockscreenAssistIconController(Dependency dependency, Lazy<LockscreenAssistIconController> lazy) {
        dependency.mLockscreenAssistIconController = lazy;
    }

    public static void injectMLockscreenSkinningController(Dependency dependency, Lazy<LockscreenSkinningController> lazy) {
        dependency.mLockscreenSkinningController = lazy;
    }

    public static void injectMLockscreenStyleCoverController(Dependency dependency, Lazy<LockscreenStyleCoverController> lazy) {
        dependency.mLockscreenStyleCoverController = lazy;
    }
}
