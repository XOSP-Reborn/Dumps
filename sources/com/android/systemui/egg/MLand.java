...
public class MLand extends FrameLayout {
    ...
    public static class Params {
        ...
        public Params(Resources resources) {
            ...
            this.OBSTACLE_SPACING = resources.getDimensionPixelSize(C0005R$dimen.obstacle_spacing);
            ...
            this.SCENERY_Z = (float) resources.getDimensionPixelSize(C0005R$dimen.scenery_z);
            ...
            this.HUD_Z = (float) resources.getDimensionPixelSize(C0005R$dimen.hud_z);
    ...
    private int addPlayerInternal(Player player) {
        ...
        realignPlayers();
        TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0010R$layout.mland_scorefield, (ViewGroup) null);
    ...
    public void start(boolean z) {
        ...
        if (z && this.mCountdown <= 0) {
            showSplash();
            this.mSplash.findViewById(C0007R$id.play_button).setEnabled(false);
            View findViewById = this.mSplash.findViewById(C0007R$id.play_button_image);
            final TextView textView = (TextView) this.mSplash.findViewById(C0007R$id.play_button_text);
    ...
    public void showSplash() {
        ...
        if (view != null && view.getVisibility() != 0) {
            ...
            this.mSplash.findViewById(C0007R$id.play_button_image).setAlpha(1.0f);
            this.mSplash.findViewById(C0007R$id.play_button_text).setAlpha(0.0f);
            this.mSplash.findViewById(C0007R$id.play_button).setEnabled(true);
            this.mSplash.findViewById(C0007R$id.play_button).requestFocus();
        }
    }
    ...
    public static class Player extends ImageView implements GameView {
        ...
        public Player(Context context) {
            super(context);
            setBackgroundResource(C0006R$drawable.f2android);
