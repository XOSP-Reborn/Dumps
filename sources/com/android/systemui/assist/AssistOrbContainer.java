...
public class AssistOrbContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mScrim = findViewById(C0007R$id.assist_orb_scrim);
        this.mNavbarScrim = findViewById(C0007R$id.assist_orb_navbar_scrim);
        this.mOrb = (AssistOrbView) findViewById(C0007R$id.assist_orb);
    }
