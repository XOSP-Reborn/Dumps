    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                ...
                int[] r0 = com.android.systemui.doze.DozeDockHandler.AnonymousClass1.$SwitchMap$com$android$systemui$doze$DozeMachine$State     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = com.android.systemui.doze.DozeDockHandler.AnonymousClass1.$SwitchMap$com$android$systemui$doze$DozeMachine$State     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = com.android.systemui.doze.DozeDockHandler.AnonymousClass1.$SwitchMap$com$android$systemui$doze$DozeMachine$State     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = com.android.systemui.doze.DozeDockHandler.AnonymousClass1.$SwitchMap$com$android$systemui$doze$DozeMachine$State     // Catch:{ NoSuchFieldError -> 0x0035 }
        ...
        if (i != 1) {
            ...
            if (this.mDockState == 1) {
                this.mHandler.post(new Runnable(state2) {
                    /* class com.android.systemui.doze.$$Lambda$DozeDockHandler$G1vlJ8PUXQ7yuPGBUT3Rojg64gY */
