...
public class DozeLog {
    ...
    private static void init(Context context) {
        synchronized (DozeLog.class) {
            if (sMessages == null) {
                ...
                sProxStats = (SummaryStats[][]) Array.newInstance(SummaryStats.class, 12, 2);
                for (int i = 0; i < 12; i++) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0031, code lost:
        if (com.android.systemui.doze.DozeLog.DEBUG == false) goto L_?;
     */
    ...
    private static void log(java.lang.String r5) {
        /*
            ...
            monitor-enter(r0)
            java.lang.String[] r1 = com.android.systemui.doze.DozeLog.sMessages     // Catch:{ all -> 0x0039 }
            if (r1 != 0) goto L_0x0009
            monitor-exit(r0)     // Catch:{ all -> 0x0039 }
            return
        L_0x0009:
            long[] r1 = com.android.systemui.doze.DozeLog.sTimes     // Catch:{ all -> 0x0039 }
            int r2 = com.android.systemui.doze.DozeLog.sPosition     // Catch:{ all -> 0x0039 }
            long r3 = java.lang.System.currentTimeMillis()     // Catch:{ all -> 0x0039 }
            r1[r2] = r3     // Catch:{ all -> 0x0039 }
            java.lang.String[] r1 = com.android.systemui.doze.DozeLog.sMessages     // Catch:{ all -> 0x0039 }
            int r2 = com.android.systemui.doze.DozeLog.sPosition     // Catch:{ all -> 0x0039 }
            r1[r2] = r5     // Catch:{ all -> 0x0039 }
            int r1 = com.android.systemui.doze.DozeLog.sPosition     // Catch:{ all -> 0x0039 }
            int r1 = r1 + 1
            int r2 = com.android.systemui.doze.DozeLog.SIZE     // Catch:{ all -> 0x0039 }
            int r1 = r1 % r2
            com.android.systemui.doze.DozeLog.sPosition = r1     // Catch:{ all -> 0x0039 }
            int r1 = com.android.systemui.doze.DozeLog.sCount     // Catch:{ all -> 0x0039 }
            int r1 = r1 + 1
            int r2 = com.android.systemui.doze.DozeLog.SIZE     // Catch:{ all -> 0x0039 }
            int r1 = java.lang.Math.min(r1, r2)     // Catch:{ all -> 0x0039 }
            com.android.systemui.doze.DozeLog.sCount = r1     // Catch:{ all -> 0x0039 }
            monitor-exit(r0)     // Catch:{ all -> 0x0039 }
            boolean r0 = com.android.systemui.doze.DozeLog.DEBUG
