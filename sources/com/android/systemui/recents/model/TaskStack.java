...
public class TaskStack {
    ...
    public TaskStack() {
        this.mStackTaskList.setFilter(new TaskFilter() {
            /* class com.android.systemui.recents.model.TaskStack.AnonymousClass1 */
    ...
    public void removeTask(Task task, AnimationProps animationProps, boolean z, boolean z2) {
        if (this.mStackTaskList.contains(task)) {
            ...
            if (taskStackCallbacks != null) {
                taskStackCallbacks.onStackTaskRemoved(this, task, frontMostTask, animationProps, z, z2);
            }
        }
