...
public class ReferenceCountedTrigger {
    ...
    public ReferenceCountedTrigger(Runnable runnable, Runnable runnable2, Runnable runnable3) {
        ...
        this.mIncrementRunnable = new Runnable() {
            /* class com.android.systemui.recents.misc.ReferenceCountedTrigger.AnonymousClass1 */
        ...
        this.mDecrementRunnable = new Runnable() {
            /* class com.android.systemui.recents.misc.ReferenceCountedTrigger.AnonymousClass2 */
    ...
    public Animator.AnimatorListener decrementOnAnimationEnd() {
        return new AnimatorListenerAdapter() {
            /* class com.android.systemui.recents.misc.ReferenceCountedTrigger.AnonymousClass3 */
