...
public class ScreenPinningRequest implements View.OnClickListener, NavigationModeController.ModeChangedListener {
    ...
    public void onClick(View view) {
        if (view.getId() == C0007R$id.screen_pinning_ok_button || this.mRequestWindow == view) {
            try {
    ...
    public class RequestWindowView extends FrameLayout {
        ...
        public void onAttachedToWindow() {
            ...
            ((FrameLayout) this).mContext.registerReceiver(this.mReceiver, intentFilter);
        }
        ...
        private void inflateView(int i) {
            ...
            boolean z = true;
            if (i == 2) {
                i2 = C0010R$layout.screen_pinning_request_sea_phone;
            } else if (i == 1) {
                i2 = C0010R$layout.screen_pinning_request_land_phone;
            } else {
                i2 = C0010R$layout.screen_pinning_request;
            }
            ...
            this.mLayout.findViewById(C0007R$id.screen_pinning_text_area).setLayoutDirection(3);
            View findViewById = this.mLayout.findViewById(C0007R$id.screen_pinning_buttons);
            ...
            ((Button) this.mLayout.findViewById(C0007R$id.screen_pinning_ok_button)).setOnClickListener(ScreenPinningRequest.this);
            if (this.mShowCancel) {
                ((Button) this.mLayout.findViewById(C0007R$id.screen_pinning_cancel_button)).setOnClickListener(ScreenPinningRequest.this);
            } else {
                ((Button) this.mLayout.findViewById(C0007R$id.screen_pinning_cancel_button)).setVisibility(4);
            }
            StatusBar statusBar = (StatusBar) SysUiServiceProvider.getComponent(((FrameLayout) this).mContext, StatusBar.class);
            if (statusBar != null) {
            ...
            if (QuickStepContract.isGesturalMode(ScreenPinningRequest.this.mNavBarMode)) {
                i3 = C0014R$string.screen_pinning_description_gestural;
            } else if (z) {
                this.mLayout.findViewById(C0007R$id.screen_pinning_recents_group).setVisibility(0);
                this.mLayout.findViewById(C0007R$id.screen_pinning_home_bg_light).setVisibility(4);
                this.mLayout.findViewById(C0007R$id.screen_pinning_home_bg).setVisibility(4);
                if (isTouchExplorationEnabled) {
                    i3 = C0014R$string.screen_pinning_description_accessible;
                } else {
                    i3 = C0014R$string.screen_pinning_description;
                }
            } else {
                this.mLayout.findViewById(C0007R$id.screen_pinning_recents_group).setVisibility(4);
                this.mLayout.findViewById(C0007R$id.screen_pinning_home_bg_light).setVisibility(0);
                this.mLayout.findViewById(C0007R$id.screen_pinning_home_bg).setVisibility(0);
                if (isTouchExplorationEnabled) {
                    i3 = C0014R$string.screen_pinning_description_recents_invisible_accessible;
                } else {
                    i3 = C0014R$string.screen_pinning_description_recents_invisible;
                }
            }
            if (navigationBarView != null) {
                ((ImageView) this.mLayout.findViewById(C0007R$id.screen_pinning_back_icon)).setImageDrawable(navigationBarView.getBackDrawable());
                ((ImageView) this.mLayout.findViewById(C0007R$id.screen_pinning_home_icon)).setImageDrawable(navigationBarView.getHomeDrawable());
            }
            ((TextView) this.mLayout.findViewById(C0007R$id.screen_pinning_description)).setText(i3);
            if (isTouchExplorationEnabled) {
                i4 = 4;
            }
            this.mLayout.findViewById(C0007R$id.screen_pinning_back_bg).setVisibility(i4);
            this.mLayout.findViewById(C0007R$id.screen_pinning_back_bg_light).setVisibility(i4);
