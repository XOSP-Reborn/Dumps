...
public class RecentsOnboarding {
    ...
    private final View.OnAttachStateChangeListener mOnAttachStateChangeListener = new View.OnAttachStateChangeListener() {
        ...
        public void onViewAttachedToWindow(View view) {
            if (view == RecentsOnboarding.this.mLayout) {
                ...
                if (view.getTag().equals(Integer.valueOf(C0014R$string.recents_swipe_up_onboarding))) {
        ...
        public void onViewDetachedFromWindow(View view) {
            if (view == RecentsOnboarding.this.mLayout) {
                ...
                if (view.getTag().equals(Integer.valueOf(C0014R$string.recents_quick_scrub_onboarding))) {
                    ...
                    if (runningTask.configuration.windowConfiguration.getActivityType() == 1) {
                        ...
                        if (hasSeenSwipeUpOnboarding && hasSeenQuickScrubOnboarding) {
                                ...
                                if (RecentsOnboarding.this.mHasDismissedSwipeUpTip) {
                                    ...
                                    if (dismissedSwipeUpOnboardingCount <= 2) {
                                        ...
                                        if (RecentsOnboarding.this.mNumAppsLaunchedSinceSwipeUpTipDismiss >= i) {
                                            ...
                                            z2 = RecentsOnboarding.this.show(C0014R$string.recents_swipe_up_onboarding);
                                        } else {
                                            z2 = false;
                                        }
                                    } else {
                            ...
                            if (!RecentsOnboarding.this.mHasDismissedQuickScrubTip) {
                                z = RecentsOnboarding.this.show(C0014R$string.recents_quick_scrub_onboarding);
    ...
    public RecentsOnboarding(Context context, OverviewProxyService overviewProxyService) {
        ...
        Collections.addAll(this.mBlacklistedPackages, resources.getStringArray(C0001R$array.recents_onboarding_blacklisted_packages));
        this.mLayout = LayoutInflater.from(this.mContext).inflate(C0010R$layout.recents_onboarding, (ViewGroup) null);
        this.mTextView = (TextView) this.mLayout.findViewById(C0007R$id.onboarding_text);
        this.mDismissView = (ImageView) this.mLayout.findViewById(C0007R$id.dismiss);
        this.mArrowView = this.mLayout.findViewById(C0007R$id.arrow);
    ...
    public boolean show(int i) {
        ...
        if (i == C0014R$string.recents_swipe_up_onboarding) {
            i2 = 81;
        } else {
