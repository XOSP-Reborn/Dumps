...
public class TaskViewTransform {
    public static final Property<View, Rect> LTRB = new Property<View, Rect>(Rect.class, "leftTopRightBottom") {
        /* class com.android.systemui.recents.views.TaskViewTransform.AnonymousClass1 */
    ...
    public void applyToTaskView(TaskView taskView, ArrayList<Animator> arrayList, AnimationProps animationProps, boolean z) {
        if (this.visible) {
            ...
            if (z && hasTranslationZChangedFrom(taskView.getTranslationZ())) {
                ObjectAnimator ofFloat = ObjectAnimator.ofFloat(taskView, View.TRANSLATION_Z, taskView.getTranslationZ(), this.translationZ);
                animationProps.apply(3, ofFloat);
                arrayList.add(ofFloat);
            }
            if (hasScaleChangedFrom(taskView.getScaleX())) {
                ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(taskView, PropertyValuesHolder.ofFloat(View.SCALE_X, taskView.getScaleX(), this.scale), PropertyValuesHolder.ofFloat(View.SCALE_Y, taskView.getScaleX(), this.scale));
                animationProps.apply(5, ofPropertyValuesHolder);
                arrayList.add(ofPropertyValuesHolder);
            }
            if (hasAlphaChangedFrom(taskView.getAlpha())) {
                ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(taskView, View.ALPHA, taskView.getAlpha(), this.alpha);
            ...
            if (hasRectChangedFrom(taskView)) {
                ...
                ObjectAnimator ofPropertyValuesHolder2 = ObjectAnimator.ofPropertyValuesHolder(taskView, PropertyValuesHolder.ofObject(LTRB, Utilities.RECT_EVALUATOR, rect2, rect3));
