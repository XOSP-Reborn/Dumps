...
public class CrossFadeHelper {
    ...
    private static void updateLayerType(View view, float f) {
        if (!view.hasOverlappingRendering() || f <= 0.0f || f >= 1.0f) {
            if (view.getLayerType() == 2 && view.getTag(C0007R$id.cross_fade_layer_type_changed_tag) != null && view.getTag(C0007R$id.cross_fade_layer_type_changed_tag) != null) {
                view.setLayerType(0, null);
            }
        } else if (view.getLayerType() != 2) {
            view.setLayerType(2, null);
            view.setTag(C0007R$id.cross_fade_layer_type_changed_tag, true);
        }
    }
