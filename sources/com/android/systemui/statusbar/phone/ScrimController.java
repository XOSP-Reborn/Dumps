...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, ColorExtractor.OnColorsChangedListener, Dumpable {
    ...
    private static final int TAG_END_ALPHA = C0007R$id.scrim_alpha_end;
    static final int TAG_KEY_ANIM = C0007R$id.scrim;
    private static final int TAG_START_ALPHA = C0007R$id.scrim_alpha_start;
    ...
    private boolean mIsStyleCoverViewSelectedAndClosed = false;
    ...
    public ScrimController(ScrimView scrimView, ScrimView scrimView2, TriConsumer<ScrimState, Float, ColorExtractor.GradientColors> triConsumer, Consumer<Integer> consumer, DozeParameters dozeParameters, AlarmManager alarmManager) {
        ...
        this.mScrimBehindAlphaResValue = this.mContext.getResources().getFloat(C0005R$dimen.scrim_behind_alpha);
    ...
    private void applyExpansionToAlpha() {
        if (this.mExpansionAffectsAlpha) {
            ...
            if (scrimState == ScrimState.UNLOCKED) {
                ...
                if (this.mState == ScrimState.KEYGUARD && this.mSeeThroughScrim) {
                    behindAlpha = 0.0f;
                }
            ...
            } else if (!this.mIsStyleCoverViewSelectedAndClosed) {
            } else {
                if (scrimState == ScrimState.BOUNCER_SCRIMMED || scrimState == ScrimState.BOUNCER) {
                    this.mCurrentBehindAlpha = 1.0f;
                }
            }
        }
    ...
    private void startScrimAnimation(final View view, float f) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(view, view instanceof ScrimView ? ((ScrimView) view).getTint() : 0) {
            /* class com.android.systemui.statusbar.phone.$$Lambda$ScrimController$RfJJyPt1cPl4hraLjBCUJgqPhOM */
    ...
    private void blankDisplay() {
        ...
        this.mPendingFrameCallback = new Runnable() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$ScrimController$kDQtFE2BFSUNax7wJ8UgLaBZyEo */
    ...
    public /* synthetic */ void lambda$blankDisplay$2$ScrimController() {
        ...
        this.mBlankingTransitionRunnable = new Runnable() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$ScrimController$xRo1WgiULtMHpaXVTe04p0hBHI */
    ...
    public void updateSeeThroughScrimState(boolean z) {
        if (this.mSeeThroughScrim != z) {
            this.mSeeThroughScrim = z;
    ...
    public void setStyleCoverViewSelectedAndClosed(boolean z) {
        boolean z2 = this.mIsStyleCoverViewSelectedAndClosed;
        this.mIsStyleCoverViewSelectedAndClosed = z;
        if (this.mIsStyleCoverViewSelectedAndClosed != z2) {
            applyExpansionToAlpha();
            scheduleUpdate();
        }
    }
