...
public class StatusBarIconControllerImpl extends StatusBarIconList implements TunerService.Tunable, ConfigurationController.ConfigurationListener, Dumpable, CommandQueue.Callbacks, StatusBarIconController {
    ...
    public StatusBarIconControllerImpl(Context context) {
        super(context.getResources().getStringArray(17236076));
    ...
    private void addSystemIcon(int i, StatusBarIconHolder statusBarIconHolder) {
        ...
        this.mIconGroups.forEach(new Consumer(getViewIndex(i, statusBarIconHolder.getTag()), slotName, this.mIconBlacklist.contains(slotName), statusBarIconHolder) {
            /* class com.android.systemui.statusbar.phone.$$Lambda$StatusBarIconControllerImpl$fL8PZXISckai5GwvhWVS3QVTsY */
    ...
    public void setExternalIcon(String str) {
        this.mIconGroups.forEach(new Consumer(getViewIndex(getSlotIndex(str), 0), this.mContext.getResources().getDimensionPixelSize(C0005R$dimen.status_bar_icon_drawing_size)) {
            /* class com.android.systemui.statusbar.phone.$$Lambda$StatusBarIconControllerImpl$rsmVGSlXlU7ffeIAEgpWeyyu04I */
            private final /* synthetic */ int f$0;
        ...
        if (slot.hasIconsInSlot()) {
            ...
            for (StatusBarIconHolder statusBarIconHolder : slot.getHolderListInViewOrder()) {
                ...
                this.mIconGroups.forEach(new Consumer(viewIndex) {
                    /* class com.android.systemui.statusbar.phone.$$Lambda$StatusBarIconControllerImpl$uTqaHUAWHbu0P16vDWL0oAyCetk */
                    private final /* synthetic */ int f$0;
    ...
    public void removeIcon(int i, int i2) {
        if (getIcon(i, i2) != null) {
            ...
            this.mIconGroups.forEach(new Consumer(getViewIndex(i, 0)) {
                /* class com.android.systemui.statusbar.phone.$$Lambda$StatusBarIconControllerImpl$XIHL8F8kJA04U9X_9IHtSYwXxLU */
                private final /* synthetic */ int f$0;
    ...
    private void handleSet(int i, StatusBarIconHolder statusBarIconHolder) {
        this.mIconGroups.forEach(new Consumer(getViewIndex(i, statusBarIconHolder.getTag()), statusBarIconHolder) {
            /* class com.android.systemui.statusbar.phone.$$Lambda$StatusBarIconControllerImpl$ayp5xWywAkBOOSd6MshVHM8Mms */
            private final /* synthetic */ int f$0;
