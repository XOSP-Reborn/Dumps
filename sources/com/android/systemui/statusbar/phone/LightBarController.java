...
public class LightBarController implements BatteryController.BatteryStateChangeCallback, Dumpable {
    ...
    public LightBarController(Context context, DarkIconDispatcher darkIconDispatcher, BatteryController batteryController) {
        this.mDarkModeColor = Color.valueOf(context.getColor(C0004R$color.dark_mode_icon_color_single_tone));
        this.mStatusBarIconController = (SysuiDarkIconDispatcher) darkIconDispatcher;
        this.mBatteryController = batteryController;
        this.mBatteryController.addCallback(this);
        SkinningBridge.onLightBarControllerCreated(new Runnable() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$LightBarController$bSpCuHCagzvPslcgLaeM2787lvQ */

            public final void run() {
                LightBarController.this.lambda$new$0$LightBarController();
            }
        });
    }
    ...
    /* renamed from: reevaluate */
    public void lambda$new$0$LightBarController() {
    ...
    public void setQsCustomizing(boolean z) {
        if (this.mQsCustomizing != z) {
            ...
            lambda$new$0$LightBarController();
        }
    }
    ...
    private boolean isLight(int i, int i2, int i3) {
        ...
        return SkinningBridge.massageLightBarMode(z, i3);
    }
