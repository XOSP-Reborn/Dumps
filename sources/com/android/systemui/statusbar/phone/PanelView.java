...
import com.sonymobile.systemui.lockscreen.UnlockAnimationAlgorithm;
...
public abstract class PanelView extends FrameLayout {
    ...
    private final Runnable mFlingCollapseRunnable = new Runnable() {
        /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass3 */
    ...
    protected final Runnable mPostCollapseRunnable = new Runnable() {
        /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass7 */
    ...
    protected UnlockAnimationAlgorithm mUnlockAnimationAlgorithm = new UnlockAnimationAlgorithm();
    ...
    private void runPeekAnimation(long j, float f, final boolean z) {
        ...
        if (this.mHeightAnimator == null) {
            ...
            this.mPeekAnimator.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass1 */
    ...
    public PanelView(Context context, AttributeSet attributeSet) {
        ...
        this.mNotificationsDragEnabled = getResources().getBoolean(C0003R$bool.config_enableNotificationShadeDrag);
        this.mVibratorHelper = (VibratorHelper) Dependency.get(VibratorHelper.class);
        this.mVibrateOnOpening = ((FrameLayout) this).mContext.getResources().getBoolean(C0003R$bool.config_vibrateOnIconAnimation);
    ...
    public void loadDimens() {
        ...
        this.mHintDistance = resources.getDimension(C0005R$dimen.hint_move_distance);
        this.mUnlockFalsingThreshold = resources.getDimensionPixelSize(C0005R$dimen.unlock_falsing_threshold);
    }
    ...
    public void onTrackingStopped(boolean z) {
        ...
        this.mUnlockAnimationAlgorithm.setTracking(false);
    ...
    public void onTrackingStarted() {
        endClosing();
        this.mTracking = true;
        this.mUnlockAnimationAlgorithm.setTracking(true);
    ...
    public void flingToHeight(float f, boolean z, float f2, float f3, boolean z2) {
        ...
        if (z) {
            ...
            this.mFlingAnimationUtils.apply(createHeightAnimator, this.mExpandedHeight, f2, f, (float) getHeight());
            if (f == 0.0f) {
                createHeightAnimator.setDuration(350L);
            }
        } else {
            if (!shouldUseDismissingAnimation()) {
                this.mFlingAnimationUtilsClosing.apply(createHeightAnimator, this.mExpandedHeight, f2, f, (float) getHeight());
            } else if (f == 0.0f) {
                ...
                this.mFlingAnimationUtilsDismissing.apply(createHeightAnimator, this.mExpandedHeight, f2, f, (float) getHeight());
            }
            if (f == 0.0f) {
        ...
        if (this.mPerf != null) {
            this.mPerf.perfHint(4224, ((FrameLayout) this).mContext.getPackageName(), -1, 3);
        }
        createHeightAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass2 */
            private boolean mCancelled;
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                PanelView.this.mFlinging = false;
                PanelView.this.mUnlockAnimationAlgorithm.setFlinging(false);
        ...
        this.mFlinging = true;
        this.mUnlockAnimationAlgorithm.setFlinging(true);
    ...
    public void setExpandedHeightInternal(float f) {
        ...
        if (this.mExpandLatencyTracking && f != 0.0f) {
            DejankUtils.postAfterTraversal(new Runnable() {
                /* class com.android.systemui.statusbar.phone.$$Lambda$PanelView$NcQsgCLFImw9_GKeELFJ1HpKiII */
    ...
    /* access modifiers changed from: protected */
    public boolean isFlingingKeyguard() {
        return (this.mFlinging || (!this.mTracking && isFullyCollapsed())) && isKeyguardShowing();
    }
    ...
    public boolean canPanelBeCollapsed() {
        return ((!isFullyCollapsed() && !this.mTracking) || isKeyguardShowing()) && !this.mClosing;
    }
    ...
    public void expand(boolean z) {
        if (isFullyCollapsed() || isCollapsing()) {
            ...
            getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass4 */
    ...
    public void startUnlockHintAnimation() {
        if (this.mHeightAnimator == null && !this.mTracking) {
            ...
            startUnlockHintAnimationPhase1(new Runnable() {
                /* class com.android.systemui.statusbar.phone.$$Lambda$PanelView$tAljekoGx9mlKIleW6Fmi59MCOs */
    ...
    public /* synthetic */ void lambda$startUnlockHintAnimation$1$PanelView() {
        ...
        this.mUnlockAnimationAlgorithm.setFlinging(false);
    }
    ...
    private void startUnlockHintAnimationPhase1(final Runnable runnable) {
        ...
        createHeightAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass5 */
            private boolean mCancelled;
        ...
        for (View view : viewArr) {
            if (view != null) {
                view.animate().translationY(-this.mHintDistance).setDuration(250).setInterpolator(Interpolators.FAST_OUT_SLOW_IN).withEndAction(new Runnable(view) {
                    /* class com.android.systemui.statusbar.phone.$$Lambda$PanelView$NxwxpLj3ZElyZwbMmniBqBlhdY */
    ...
    private void startUnlockHintAnimationPhase2(final Runnable runnable) {
        ...
        createHeightAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.phone.PanelView.AnonymousClass6 */
    ...
    private ValueAnimator createHeightAnimator(float f) {
        ...
        ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$PanelView$IAIF_ME3fPevHucfSNmkDD_eY */
