...
public class ExpandableIndicator extends ImageView {
    ...
    private String getContentDescription(boolean z) {
        if (z) {
            return ((ImageView) this).mContext.getString(C0014R$string.accessibility_quick_settings_collapse);
        }
        return ((ImageView) this).mContext.getString(C0014R$string.accessibility_quick_settings_expand);
    }
