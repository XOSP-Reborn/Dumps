...
public class NavigationBarFragment extends LifecycleFragment implements CommandQueue.Callbacks, NavigationModeController.ModeChangedListener {
    ...
    public NavigationBarFragment(AccessibilityManagerWrapper accessibilityManagerWrapper, DeviceProvisionedController deviceProvisionedController, MetricsLogger metricsLogger, AssistManager assistManager, OverviewProxyService overviewProxyService, NavigationModeController navigationModeController, StatusBarStateController statusBarStateController) {
        ...
        this.mOverviewProxyListener = new OverviewProxyService.OverviewProxyListener() {
            ...
            public void onNavBarButtonAlphaChanged(float f, boolean z) {
                ...
                if (QuickStepContract.isSwipeUpMode(NavigationBarFragment.this.mNavBarMode)) {
                    ...
                    buttonDispatcher = QuickStepContract.isGesturalMode(NavigationBarFragment.this.mNavBarMode) ? NavigationBarFragment.this.mNavigationBarView.getHomeHandle() : null;
                }
        ...
        this.mRotationWatcher = new Consumer() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$NavigationBarFragment$JVziusX7tSv19aMDDuLOISWKI8 */
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.mAutoDimTimeout = getContext().getResources().getInteger(C0008R$integer.navbar_auto_dim_timeout);
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return layoutInflater.inflate(C0010R$layout.navigation_bar, viewGroup, false);
    }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (Build.IS_DEBUGGABLE) {
            this.mNavigationBarView.getViewRootImpl().dump("NavigationBarView:", fileDescriptor, printWriter, strArr);
        }
    }
    ...
    public void setSystemUiVisibility(int i, int i2, int i3, int i4, int i5, Rect rect, Rect rect2, boolean z) {
        ...
        if (i == this.mDisplayId) {
            ...
            if ((i8 ^ i7) != 0) {
                ...
                int i10 = this.mNavigationBarMode;
                if ((this.mSystemUiVisibility & 16) != 16) {
                    z3 = false;
                }
                SkinningBridge.onNavigationBarModeChanged(i10, z3);
    ...
    private void prepareNavigationBarView() {
        ...
        homeButton.setOnLongClickListener(new View.OnLongClickListener() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$8vcstZEv0YyG7EUTK_UrsNSFXRo */
    ...
    public boolean onLongPressBackHome(View view) {
        return onLongPressNavigationButtons(view, C0007R$id.back, C0007R$id.home);
    }

    /* access modifiers changed from: private */
    public boolean onLongPressBackRecents(View view) {
        return onLongPressNavigationButtons(view, C0007R$id.back, C0007R$id.recent_apps);
    }
    ...
    private boolean onLongPressNavigationButtons(View view, int i, int i2) {
        ...
        try {
            ...
            if (isInLockTaskMode && !isTouchExplorationEnabled) {
                ...
                z = false;
            } else if (i2 == C0007R$id.recent_apps) {
    ...
    public void touchAutoDim() {
        ...
        if (state != 1 && state != 2) {
            this.mHandler.postDelayed(this.mAutoDim, (long) this.mAutoDimTimeout);
        }
    }
    ...
    public void onNavigationModeChanged(int i) {
        ...
        if (ActivityManagerWrapper.getInstance().getCurrentUserId() != 0) {
            this.mHandler.post(new Runnable() {
                /* class com.android.systemui.statusbar.phone.$$Lambda$NavigationBarFragment$NAJe_hU0PesszyJ9wLZ6PYoS4_0 */
    ...
    public void disableAnimationsDuringHide(long j) {
        ...
        this.mNavigationBarView.postDelayed(new Runnable() {
            /* class com.android.systemui.statusbar.phone.$$Lambda$NavigationBarFragment$i3mhmHWtnMuMGNO528iejYx75q0 */
    ...
    public static View create(Context context, final FragmentHostManager.FragmentListener fragmentListener) {
        ...
        layoutParams.accessibilityTitle = context.getString(C0014R$string.nav_bar);
        layoutParams.windowAnimations = 0;
        layoutParams.privateFlags = layoutParams.privateFlags | 16777216;
        View inflate = LayoutInflater.from(context).inflate(C0010R$layout.navigation_bar_window, (ViewGroup) null);
        if (inflate == null) {
            return null;
        }
        inflate.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            ...
            public void onViewAttachedToWindow(View view) {
                ...
                fragmentHostManager.getFragmentManager().beginTransaction().replace(C0007R$id.navigation_bar_frame, NavigationBarFragment.this, "NavigationBar").commit();
