...
public class ScreenPinningNotify {
    ...
    public void showPinningStartToast() {
        makeAllUserToastAndShow(C0014R$string.screen_pinning_start);
    }

    public void showPinningExitToast() {
        makeAllUserToastAndShow(C0014R$string.screen_pinning_exit);
    }
    ...
    public void showEscapeToast(boolean z) {
        ...
        if (z) {
            i = C0014R$string.screen_pinning_toast;
        } else {
            i = C0014R$string.screen_pinning_toast_recents_invisible;
        }
