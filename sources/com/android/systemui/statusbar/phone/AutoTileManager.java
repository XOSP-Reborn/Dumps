            ...
            if (!AutoTileManager.this.mAutoTracker.isAdded("cast")) {
                ...
                if (z) {
                    ...
                    AutoTileManager.this.mHandler.post(new Runnable() {
                        /* class com.android.systemui.statusbar.phone.$$Lambda$AutoTileManager$6$Es5SN3RKnhrBR7n3pYQ0OR57uE */

                        public final void run() {
                            AutoTileManager.AnonymousClass6.this.lambda$onCastDevicesChanged$0$AutoTileManager$6();
                        }
                    });
                }
            }
    ...
    private final DataSaverController.Listener mDataSaverListener = new DataSaverController.Listener() {
        ...
        public void onDataSaverChanged(boolean z) {
            if (!AutoTileManager.this.mAutoTracker.isAdded("saver") && z) {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() {
                    /* class com.android.systemui.statusbar.phone.$$Lambda$AutoTileManager$3$jtlbOv9xqjXTNoW_lFuZ_dYzc1k */
    ...
    private final HotspotController.Callback mHotspotCallback = new HotspotController.Callback() {
        ...
        public void onHotspotChanged(boolean z, int i) {
            if (!AutoTileManager.this.mAutoTracker.isAdded("hotspot") && z) {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() {
                    /* class com.android.systemui.statusbar.phone.$$Lambda$AutoTileManager$4$B3sgSxASy9hbK7cekuTaJNclHvY */
    ...
    final NightDisplayListener.Callback mNightDisplayCallback = new NightDisplayListener.Callback() {
        ...
        private void addNightTile() {
            if (!AutoTileManager.this.mAutoTracker.isAdded("night")) {
                ...
                AutoTileManager.this.mHandler.post(new Runnable() {
                    /* class com.android.systemui.statusbar.phone.$$Lambda$AutoTileManager$5$RSaNJ4x5t8UQTrBCygb8uU0S0 */
            ...
            this.mColorsSetting = new SecureSetting(this.mContext, this.mHandler, "accessibility_display_inversion_enabled") {
                ...
                public void handleValueChanged(int i, boolean z) {
                    if (!AutoTileManager.this.mAutoTracker.isAdded("inversion") && i != 0) {
                        ...
                        AutoTileManager.this.mHandler.post(new Runnable() {
                            /* class com.android.systemui.statusbar.phone.$$Lambda$AutoTileManager$1$fkFB83CLnhxsYFtYdorSMjVQp8g */
