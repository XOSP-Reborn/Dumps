...
public class NavigationBarInflaterView extends FrameLayout implements NavigationModeController.ModeChangedListener {
    ...
    private void inflateChildren() {
        removeAllViews();
        this.mHorizontal = (FrameLayout) this.mLayoutInflater.inflate(C0010R$layout.navigation_layout, (ViewGroup) this, false);
        addView(this.mHorizontal);
        this.mVertical = (FrameLayout) this.mLayoutInflater.inflate(C0010R$layout.navigation_layout_vertical, (ViewGroup) this, false);
    ...
    public String getDefaultLayout() {
        ...
        if (QuickStepContract.isGesturalMode(this.mNavBarMode)) {
            i = C0014R$string.config_navBarLayoutHandle;
        } else if (this.mOverviewProxyService.shouldShowSwipeUpUI()) {
            i = C0014R$string.config_navBarLayoutQuickstep;
        } else {
            i = C0014R$string.config_navBarLayout;
        }
        return getContext().getString(i);
    }

    /* access modifiers changed from: protected */
    public String getDefaultLockLayout() {
        int i;
        if (this.mOverviewProxyService.shouldShowSwipeUpUI()) {
            i = C0014R$string.config_navBarLockLayoutQuickstep;
        } else {
            i = C0014R$string.config_navBarLockLayout;
        }
        return ((FrameLayout) this).mContext.getString(i);
    }
    ...
    private void updateAlternativeOrder() {
        updateAlternativeOrder(this.mHorizontal.findViewById(C0007R$id.ends_group));
        updateAlternativeOrder(this.mHorizontal.findViewById(C0007R$id.center_group));
        updateAlternativeOrder(this.mVertical.findViewById(C0007R$id.ends_group));
        updateAlternativeOrder(this.mVertical.findViewById(C0007R$id.center_group));
        updateAlternativeOrder(this.mHorizontal.findViewById(C0007R$id.lock_group));
        updateAlternativeOrder(this.mVertical.findViewById(C0007R$id.lock_group));
    }
    ...
    private void initiallyFill(ButtonDispatcher buttonDispatcher) {
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.ends_group));
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.center_group));
        addAll(buttonDispatcher, (ViewGroup) this.mVertical.findViewById(C0007R$id.ends_group));
        addAll(buttonDispatcher, (ViewGroup) this.mVertical.findViewById(C0007R$id.center_group));
        addAll(buttonDispatcher, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.lock_group));
        addAll(buttonDispatcher, (ViewGroup) this.mVertical.findViewById(C0007R$id.lock_group));
    }
    ...
    public void inflateLayout(String str) {
        ...
        inflateButtons(split2, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.ends_group), false, true);
        inflateButtons(split2, (ViewGroup) this.mVertical.findViewById(C0007R$id.ends_group), true, true);
        inflateButtons(split3, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.center_group), false, false);
        inflateButtons(split3, (ViewGroup) this.mVertical.findViewById(C0007R$id.center_group), true, false);
        addGravitySpacer((LinearLayout) this.mHorizontal.findViewById(C0007R$id.ends_group));
        addGravitySpacer((LinearLayout) this.mVertical.findViewById(C0007R$id.ends_group));
        inflateButtons(split4, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.ends_group), false, false);
        inflateButtons(split4, (ViewGroup) this.mVertical.findViewById(C0007R$id.ends_group), true, false);
        String[] split5 = getDefaultLockLayout().split(",");
        inflateButtons(split5, (ViewGroup) this.mHorizontal.findViewById(C0007R$id.lock_group), false, false);
        inflateButtons(split5, (ViewGroup) this.mVertical.findViewById(C0007R$id.lock_group), true, true);
    ...
    private View createView(String str, ViewGroup viewGroup, LayoutInflater layoutInflater) {
        ...
        if ("home".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.home, viewGroup, false);
        }
        if ("back".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.back, viewGroup, false);
        }
        if ("recent".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.recent_apps, viewGroup, false);
        }
        if ("menu_ime".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.menu_ime, viewGroup, false);
        }
        if ("space".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.nav_key_space, viewGroup, false);
        }
        if ("clipboard".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.clipboard, viewGroup, false);
        }
        if ("contextual".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.contextual, viewGroup, false);
        }
        if ("lock".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.lock, viewGroup, false);
        }
        if ("home_handle".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.home_handle, viewGroup, false);
        }
        if ("ime_switcher".equals(extractButton)) {
            return layoutInflater.inflate(C0010R$layout.ime_switcher, viewGroup, false);
        }
        ...
        View inflate = layoutInflater.inflate(C0010R$layout.custom_key, viewGroup, false);
    ...
    private void clearViews() {
        ...
        clearAllChildren((ViewGroup) this.mHorizontal.findViewById(C0007R$id.nav_buttons));
        clearAllChildren((ViewGroup) this.mVertical.findViewById(C0007R$id.nav_buttons));
        clearAllChildren((ViewGroup) this.mHorizontal.findViewById(C0007R$id.nav_lock_buttons));
        clearAllChildren((ViewGroup) this.mVertical.findViewById(C0007R$id.nav_lock_buttons));
    }
