    ...
    public void onRotationProposal(int i, int i2, boolean z) {
        ...
        if (this.mRotationButton.acceptRotationProposal()) {
            if (!z) {
                ...
                if (i2 == 0 || i2 == 2) {
                    i3 = isRotationAnimationCCW ? C0015R$style.RotateButtonCCWStart90 : C0015R$style.RotateButtonCWStart90;
                } else {
                    i3 = isRotationAnimationCCW ? C0015R$style.RotateButtonCCWStart0 : C0015R$style.RotateButtonCWStart0;
                }
                this.mStyleRes = i3;
                this.mRotationButton.updateIcon();
                if (i3 == C0015R$style.RotateButtonCCWStart90) {
                    str = "rotateButtonCCWStart90";
                } else if (i3 == C0015R$style.RotateButtonCWStart90) {
                    str = "rotateButtonCWStart90";
                } else {
                    str = i3 == C0015R$style.RotateButtonCCWStart0 ? "rotateButtonCCWStart0" : "rotateButtonCWStart0";
                }
                SkinningBridge.onButtonVariantChanged(C0007R$id.rotate_suggestion, str);
