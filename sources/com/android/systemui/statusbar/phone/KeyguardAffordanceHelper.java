...
public class KeyguardAffordanceHelper {
    ...
    KeyguardAffordanceHelper(Callback callback, Context context) {
        ...
        KeyguardAffordanceView keyguardAffordanceView2 = this.mCenterIcon;
        updateIcon(keyguardAffordanceView2, 0.0f, keyguardAffordanceView2.getRestingAlpha(), false, false, true, false);
        KeyguardAffordanceView keyguardAffordanceView3 = this.mRightIcon;
        updateIcon(keyguardAffordanceView3, 0.0f, keyguardAffordanceView3.getRestingAlpha(), false, false, true, false);
        initDimens();
    }
    ...
    private void setTranslation(float f, boolean z, boolean z2) {
        ...
        if (max != this.mTranslation || z) {
            ...
            KeyguardAffordanceView keyguardAffordanceView3 = this.mCenterIcon;
            updateIcon(keyguardAffordanceView3, 0.0f, max2 * keyguardAffordanceView3.getRestingAlpha(), z3, z5, z, z4);
    ...
    private void updateIconsFromTranslation(KeyguardAffordanceView keyguardAffordanceView) {
        ...
        KeyguardAffordanceView keyguardAffordanceView3 = this.mCenterIcon;
        updateIconAlpha(keyguardAffordanceView3, max * keyguardAffordanceView3.getRestingAlpha(), false);
    }
