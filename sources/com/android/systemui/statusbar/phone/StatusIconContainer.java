...
public class StatusIconContainer extends AlphaOptimizedLinearLayout {
    ...
    private void initDimens() {
        this.mIconDotFrameWidth = getResources().getDimensionPixelSize(17105430);
        this.mDotPadding = getResources().getDimensionPixelSize(C0005R$dimen.overflow_icon_dot_padding);
        this.mStaticDotDiameter = getResources().getDimensionPixelSize(C0005R$dimen.overflow_dot_radius) * 2;
    ...
    public void onViewAdded(View view) {
        ...
        view.setTag(C0007R$id.status_bar_view_state_tag, statusIconState);
    }

    public void onViewRemoved(View view) {
        super.onViewRemoved(view);
        view.setTag(C0007R$id.status_bar_view_state_tag, null);
    }
    ...
    private static StatusIconState getViewStateFromChild(View view) {
        return (StatusIconState) view.getTag(C0007R$id.status_bar_view_state_tag);
    }
