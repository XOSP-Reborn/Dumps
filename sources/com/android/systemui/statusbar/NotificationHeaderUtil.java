...
public class NotificationHeaderUtil {
    private static final ResultApplicator mGreyApplicator = new ResultApplicator() {
        /* class com.android.systemui.statusbar.NotificationHeaderUtil.AnonymousClass4 */
        ...
        public void apply(View view, boolean z) {
            ...
            applyToChild((ImageView) view.findViewById(16908903), z, notificationHeaderView.getOriginalNotificationColor());
        }
    ...
    private static final IconComparator sGreyComparator = new IconComparator() {
        /* class com.android.systemui.statusbar.NotificationHeaderUtil.AnonymousClass3 */
    ...
    public NotificationHeaderUtil(ExpandableNotificationRow expandableNotificationRow) {
        ...
        this.mComparators.add(new HeaderProcessor(this.mRow, 16909169, sIconExtractor, sGreyComparator, mGreyApplicator));
        this.mComparators.add(new HeaderProcessor(this.mRow, 16909263, null, new ViewComparator() {
        ...
        this.mComparators.add(HeaderProcessor.forTextView(this.mRow, 16908982));
        this.mDividers.add(16908983);
        this.mDividers.add(16908985);
        this.mDividers.add(16909470);
    }
    ...
    private void sanitizeChild(View view) {
        if (view != null) {
            sanitizeHeader((NotificationHeaderView) view.findViewById(16909169));
        }
    }
    ...
    private void sanitizeHeader(NotificationHeaderView notificationHeaderView) {
        ...
        if (notificationHeaderView != null) {
            ...
            View findViewById = notificationHeaderView.findViewById(16909466);
            int i2 = 1;
            while (true) {
                i = childCount - 1;
                if (i2 >= i) {
