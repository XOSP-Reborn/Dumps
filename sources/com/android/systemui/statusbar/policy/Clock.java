        ...
        this.mIntentReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (action.equals("android.intent.action.TIMEZONE_CHANGED")) {
                    Clock.this.getHandler().post(new Runnable(intent.getStringExtra("time-zone")) {
                    ...
                    Clock.this.getHandler().post(new Runnable(Clock.this.getResources().getConfiguration().locale) {
    ...
    private void updateShowSeconds() {
        if (this.mShowSeconds) {
            if (this.mSecondsHandler == null && getDisplay() != null) {
                ...
                ((TextView) this).mContext.registerReceiver(this.mScreenReceiver, intentFilter);
            }
