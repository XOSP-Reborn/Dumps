...
public final class SmartReplyConstants {
    ...
    public SmartReplyConstants(Handler handler, Context context) {
        ...
        this.mDefaultMaxSqueezeRemeasureAttempts = resources.getInteger(C0008R$integer.config_smart_replies_in_notifications_max_squeeze_remeasure_attempts);
        ...
        this.mDefaultMinNumSystemGeneratedReplies = resources.getInteger(C0008R$integer.config_smart_replies_in_notifications_min_num_system_generated_replies);
        this.mDefaultMaxNumActions = resources.getInteger(C0008R$integer.config_smart_replies_in_notifications_max_num_actions);
        this.mDefaultOnClickInitDelay = resources.getInteger(C0008R$integer.config_smart_replies_in_notifications_onclick_init_delay);
    ...
    private void registerDeviceConfigListener() {
        DeviceConfig.addOnPropertiesChangedListener("systemui", new Executor() {
            ...
            /* class com.android.systemui.statusbar.policy.$$Lambda$SmartReplyConstants$4opgQ5IrqXO7Mn9_Fp2x2nMZNY */
