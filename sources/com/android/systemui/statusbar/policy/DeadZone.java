...
public class DeadZone {
    ...
    public void onConfigurationChanged(int i) {
        ...
        this.mHold = resources.getInteger(C0008R$integer.navigation_bar_deadzone_hold);
        this.mDecay = resources.getInteger(C0008R$integer.navigation_bar_deadzone_decay);
        ...
        boolean z = true;
        if (resources.getInteger(C0008R$integer.navigation_bar_deadzone_orientation) != 1) {
            z = false;
        }
        this.mVertical = z;
