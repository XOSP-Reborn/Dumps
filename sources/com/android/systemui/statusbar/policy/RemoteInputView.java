...
public class RemoteInputView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public void onFinishInflate() {
        ...
        this.mProgressBar = (ProgressBar) findViewById(C0007R$id.remote_input_progress);
        this.mSendButton = (ImageButton) findViewById(C0007R$id.remote_input_send);
    ...
    private void sendRemoteInput() {
        ...
        MetricsLogger.action(((LinearLayout) this).mContext, 398, this.mEntry.notification.getPackageName());
        try {
            this.mPendingIntent.send(((LinearLayout) this).mContext, 0, addFlags);
        } catch (PendingIntent.CanceledException e) {
            Log.i("RemoteInput", "Unable to send remote input result", e);
            MetricsLogger.action(((LinearLayout) this).mContext, 399, this.mEntry.notification.getPackageName());
        }
    }
    ...
    public static RemoteInputView inflate(Context context, ViewGroup viewGroup, NotificationEntry notificationEntry, RemoteInputController remoteInputController) {
        RemoteInputView remoteInputView = (RemoteInputView) LayoutInflater.from(context).inflate(C0010R$layout.remote_input, viewGroup, false);
    ...
    private void onDefocus(boolean z) {
        ...
        MetricsLogger.action(((LinearLayout) this).mContext, 400, this.mEntry.notification.getPackageName());
    }
    ...
    public void focus() {
        MetricsLogger.action(((LinearLayout) this).mContext, 397, this.mEntry.notification.getPackageName());
        setVisibility(0);
        NotificationViewWrapper notificationViewWrapper = this.mWrapper;
        if (notificationViewWrapper != null) {
