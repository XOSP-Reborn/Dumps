...
public class KeyguardAffordanceView extends ImageView {
    ...
    public KeyguardAffordanceView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mFlingAnimationUtils = new FlingAnimationUtils(((ImageView) this).mContext, 0.3f);
    ...
    private void updateIconColor() {
        if (this.mShouldTint) {
            getDrawable().mutate().setColorFilter(((Integer) this.mColorInterpolator.evaluate(Math.min(1.0f, this.mCircleRadius / ((float) this.mMinBackgroundRadius)), Integer.valueOf(this.mNormalColor), Integer.valueOf(this.mDarkIconColor))).intValue(), PorterDuff.Mode.SRC_IN);
        }
    }
    ...
    private void updateCircleColor() {
        ...
        this.mCirclePaint.setColor(Color.argb((int) (max * 255.0f), Color.red(this.mCircleColor), Color.green(this.mCircleColor), Color.blue(this.mCircleColor)));
    }
