...
public class NotificationDozeHelper {
    private static final int DOZE_ANIMATOR_TAG = C0007R$id.doze_intensity_tag;
    ...
    public void setIntensityDark(Consumer<Float> consumer, boolean z, boolean z2, long j, final View view) {
        if (z2) {
            startIntensityAnimation(new ValueAnimator.AnimatorUpdateListener(consumer) {
                /* class com.android.systemui.statusbar.notification.$$Lambda$NotificationDozeHelper$cAhupcRGr8viAUyxaXt90IAG2is */
