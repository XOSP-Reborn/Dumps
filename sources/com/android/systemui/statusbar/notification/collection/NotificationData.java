...
public class NotificationData {
    ...
    protected final Comparator<NotificationEntry> mRankingComparator = new Comparator<NotificationEntry>() {
        /* class com.android.systemui.statusbar.notification.collection.NotificationData.AnonymousClass1 */
        ...
        public int compare(NotificationEntry notificationEntry, NotificationEntry notificationEntry2) {
            ...
            if (isHeadsUp != isHeadsUp2) {
                ...
                if (notificationEntry.getRow().showingAmbientPulsing() != notificationEntry2.getRow().showingAmbientPulsing()) {
    ...
    public void filterAndSort(boolean z) {
        ...
        this.mNotificationFilter.resetHideNotificationState();
        synchronized (this.mEntries) {
            int size = this.mEntries.size();
            for (int i = 0; i < size; i++) {
                NotificationEntry valueAt = this.mEntries.valueAt(i);
                if (!this.mNotificationFilter.shouldFilterOut(valueAt, z)) {
