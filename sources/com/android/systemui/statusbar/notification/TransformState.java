...
public class TransformState {
    ...
    private static final int TRANSFORMATION_START_SCLALE_X = C0007R$id.transformation_start_scale_x_tag;
    private static final int TRANSFORMATION_START_SCLALE_Y = C0007R$id.transformation_start_scale_y_tag;
    private static final int TRANSFORMATION_START_X = C0007R$id.transformation_start_x_tag;
    private static final int TRANSFORMATION_START_Y = C0007R$id.transformation_start_y_tag;
