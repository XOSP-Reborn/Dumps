    ...
    public void onClick(View view) {
        ...
        if (statusBarNotification == null) {
            ...
            DejankUtils.postAfterTraversal(new Runnable() {
                /* class com.android.systemui.statusbar.notification.$$Lambda$NotificationClicker$nu7GkRUU5fnNpaTPmGoBAs8FJoU */

                public final void run() {
                    NotificationClicker.lambda$onClick$0(ExpandableNotificationRow.this);
                }
            });
