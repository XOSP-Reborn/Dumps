...
public interface NotificationEntryListener {
    default void onBeforeNotificationAdded(NotificationEntry notificationEntry) {
    }

    default void onEntryInflated(NotificationEntry notificationEntry, int i) {
    }

    default void onEntryReinflated(NotificationEntry notificationEntry) {
    }

    default void onEntryRemoved(NotificationEntry notificationEntry, NotificationVisibility notificationVisibility, boolean z) {
    }
