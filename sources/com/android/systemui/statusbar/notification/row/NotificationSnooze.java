...
public class NotificationSnooze extends LinearLayout implements NotificationGuts.GutsContent, View.OnClickListener {
    ...
    private static final int[] sAccessibilityActions = {C0007R$id.action_snooze_shorter, C0007R$id.action_snooze_short, C0007R$id.action_snooze_long, C0007R$id.action_snooze_longer};
    ...
    public void onFinishInflate() {
        ...
        findViewById(C0007R$id.notification_snooze).setOnClickListener(this);
        this.mSelectedOptionText = (TextView) findViewById(C0007R$id.snooze_option_default);
        this.mUndoButton = (TextView) findViewById(C0007R$id.undo);
        this.mUndoButton.setOnClickListener(this);
        this.mExpandButton = (ImageView) findViewById(C0007R$id.expand_button);
        this.mDivider = findViewById(C0007R$id.divider);
        this.mDivider.setAlpha(0.0f);
        this.mSnoozeOptionContainer = (ViewGroup) findViewById(C0007R$id.snooze_options);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_snooze_undo, getResources().getString(C0014R$string.snooze_undo)));
    ...
    public boolean performAccessibilityActionInternal(int i, Bundle bundle) {
        ...
        if (i == C0007R$id.action_snooze_undo) {
    ...
    public void setSnoozeOptions(List<SnoozeCriterion> list) {
        if (list != null) {
            ...
            for (int i = 0; i < min; i++) {
                ...
                this.mSnoozeOptions.add(new NotificationSnoozeOption(snoozeCriterion, 0, snoozeCriterion.getExplanation(), snoozeCriterion.getConfirmation(), new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_snooze_assistant_suggestion_1, snoozeCriterion.getExplanation())));
            }
            createOptionViews();
        }
    }
    ...
    public ArrayList<NotificationSwipeActionHelper.SnoozeOption> getDefaultSnoozeOptions() {
        ...
        int i = this.mParser.getInt("default", resources.getInteger(C0008R$integer.config_notification_snooze_time_default));
    ...
    private NotificationSwipeActionHelper.SnoozeOption createOption(int i, int i2) {
        ...
        boolean z = i >= 60;
        if (z) {
            i3 = C0012R$plurals.snoozeHourOptions;
        } else {
            i3 = C0012R$plurals.snoozeMinuteOptions;
        }
        int i4 = z ? i / 60 : i;
        String quantityString = resources.getQuantityString(i3, i4, Integer.valueOf(i4));
        String format = String.format(resources.getString(C0014R$string.snoozed_for_time), quantityString);
    ...
    private void createOptionViews() {
        ...
        for (int i = 0; i < this.mSnoozeOptions.size(); i++) {
            ...
            TextView textView = (TextView) layoutInflater.inflate(C0010R$layout.notification_snooze_option, this.mSnoozeOptionContainer, false);
    ...
    private void showSnoozeOptions(boolean z) {
        this.mExpandButton.setImageResource(z ? 17302348 : 17302408);
        if (this.mExpanded != z) {
            this.mExpanded = z;
    ...
    public void onClick(View view) {
        ...
        if (snoozeOption != null) {
            setSelected(snoozeOption, true);
        } else if (id == C0007R$id.notification_snooze) {
