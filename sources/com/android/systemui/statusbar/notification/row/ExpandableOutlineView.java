...
public abstract class ExpandableOutlineView extends ExpandableView {
    private static final AnimatableProperty BOTTOM_ROUNDNESS = AnimatableProperty.from("bottomRoundness", $$Lambda$ExpandableOutlineView$ZLqiUGCQzNj3P4m8kfbTwbzfyaI.INSTANCE, $$Lambda$RLFq7_ULx7AWbuaAJNsAxNrN1PI.INSTANCE, C0007R$id.bottom_roundess_animator_tag, C0007R$id.bottom_roundess_animator_end_tag, C0007R$id.bottom_roundess_animator_start_tag);
    private static final Path EMPTY_PATH = new Path();
    private static final AnimationProperties ROUNDNESS_PROPERTIES;
    private static final AnimatableProperty TOP_ROUNDNESS = AnimatableProperty.from("topRoundness", $$Lambda$ExpandableOutlineView$lgIjKBD4iaJhFeEZ5izPzOddhds.INSTANCE, $$Lambda$iDWyu_PNFZfGQr9kcCLSWoFYxpI.INSTANCE, C0007R$id.top_roundess_animator_tag, C0007R$id.top_roundess_animator_end_tag, C0007R$id.top_roundess_animator_start_tag);
    ...
    private void initDimens() {
        ...
        this.mAlwaysRoundBothCorners = resources.getBoolean(C0003R$bool.config_clipNotificationsToOutline);
