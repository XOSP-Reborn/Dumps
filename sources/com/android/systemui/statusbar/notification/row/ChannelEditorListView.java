...
public final class ChannelEditorListView extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        View findViewById = findViewById(C0007R$id.app_control);
    ...
    private final void addChannelRow(NotificationChannel notificationChannel, LayoutInflater layoutInflater) {
        View inflate = layoutInflater.inflate(C0010R$layout.notif_half_shelf_row, (ViewGroup) null);
        if (inflate != null) {
    ...
    private final void updateAppControlRow(boolean z) {
        ...
        if (appControlView != null) {
            ...
            if (appControlView2 != null) {
                ...
                channelName.setText(context.getResources().getString(C0014R$string.notification_channel_dialog_title, this.appName));
