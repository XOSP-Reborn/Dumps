...
public class HybridGroupManager {
    ...
    private HybridNotificationView inflateHybridViewWithStyle(int i) {
        HybridNotificationView hybridNotificationView = (HybridNotificationView) ((LayoutInflater) new ContextThemeWrapper(this.mContext, i).getSystemService(LayoutInflater.class)).inflate(C0010R$layout.hybrid_notification, this.mParent, false);
        this.mParent.addView(hybridNotificationView);
        return hybridNotificationView;
    }

    private TextView inflateOverflowNumber() {
        TextView textView = (TextView) ((LayoutInflater) this.mContext.getSystemService(LayoutInflater.class)).inflate(C0010R$layout.hybrid_overflow_number, this.mParent, false);
    ...
    public HybridNotificationView bindFromNotification(HybridNotificationView hybridNotificationView, Notification notification) {
        return bindFromNotificationWithStyle(hybridNotificationView, notification, C0015R$style.HybridNotification);
    }
    ...
    public TextView bindOverflowNumber(TextView textView, int i) {
        ...
        String string = this.mContext.getResources().getString(C0014R$string.notification_group_overflow_indicator, Integer.valueOf(i));
        if (!string.equals(textView.getText())) {
            textView.setText(string);
        }
        textView.setContentDescription(String.format(this.mContext.getResources().getQuantityString(C0012R$plurals.notification_group_overflow_description, i), Integer.valueOf(i)));
