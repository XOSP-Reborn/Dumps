...
public abstract class ActivatableNotificationView extends ExpandableOutlineView {
    ...
    public ActivatableNotificationView(Context context, AttributeSet attributeSet) {
        ...
        $$Lambda$ActivatableNotificationView$raBogtwUDgGzree3QaRWS5kgw_g r2 = new DoubleTapHelper.ActivationListener() {
            /* class com.android.systemui.statusbar.notification.row.$$Lambda$ActivatableNotificationView$raBogtwUDgGzree3QaRWS5kgw_g */
        ...
        $$Lambda$ActivatableNotificationView$fZ3qu4yQQcyUWjUQZMAyhFN3cZI r3 = new DoubleTapHelper.DoubleTapListener() {
            /* class com.android.systemui.statusbar.notification.row.$$Lambda$ActivatableNotificationView$fZ3qu4yQQcyUWjUQZMAyhFN3cZI */
    ...
    public void onFinishInflate() {
        ...
        this.mBackgroundNormal = (NotificationBackgroundView) findViewById(C0007R$id.backgroundNormal);
        this.mFakeShadow = (FakeShadowView) findViewById(C0007R$id.fake_shadow);
        this.mShadowHidden = this.mFakeShadow.getVisibility() != 0;
        this.mBackgroundDimmed = (NotificationBackgroundView) findViewById(C0007R$id.backgroundDimmed);
        initBackground();
        updateBackground();
        updateBackgroundTint();
        updateOutlineAlpha();
    ...
    private void updateBackgroundTint(boolean z) {
        ...
        if (calculateBgColor != i) {
            ...
            this.mBackgroundColorAnimator.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.statusbar.notification.row.ActivatableNotificationView.AnonymousClass6 */
    ...
    private void fadeDimmedBackground() {
        ...
        this.mBackgroundAnimator = ObjectAnimator.ofFloat(this.mBackgroundNormal, View.ALPHA, f2, f);
        ...
        this.mBackgroundAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.notification.row.ActivatableNotificationView.AnonymousClass7 */
    ...
    private void startAppearAnimation(final boolean z, float f, long j, long j2, final Runnable runnable, AnimatorListenerAdapter animatorListenerAdapter) {
        ...
        this.mAppearAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            /* class com.android.systemui.statusbar.notification.row.ActivatableNotificationView.AnonymousClass8 */
        ...
        this.mAppearAnimator.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.statusbar.notification.row.ActivatableNotificationView.AnonymousClass9 */
