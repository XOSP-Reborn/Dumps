...
public class NotificationMenuRow implements NotificationMenuRowPlugin, View.OnClickListener, ExpandableNotificationRow.LayoutListener {
    ...
    public void onTouchMove(float f) {
        ...
        if (this.mShouldShowMenu && !NotificationStackScrollLayout.isPinnedHeadsUp(getParent()) && !this.mParent.areGutsExposed() && !this.mParent.isDark() && !this.mParent.showingAmbientPulsing()) {
    ...
    private void setAppName(String str, ArrayList<NotificationMenuRowPlugin.MenuItem> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            String format = String.format(resources.getString(C0014R$string.notification_menu_accessibility), str, menuItem.getContentDescription());
    ...
    static NotificationMenuRowPlugin.MenuItem createSnoozeItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0014R$string.notification_menu_snooze_description), (NotificationSnooze) LayoutInflater.from(context).inflate(C0010R$layout.notification_snooze, (ViewGroup) null, false), C0006R$drawable.ic_snooze);
    }

    static NotificationMenuItem createInfoItem(Context context) {
        return new NotificationMenuItem(context, context.getResources().getString(C0014R$string.notification_menu_gear_description), (NotificationInfo) LayoutInflater.from(context).inflate(C0010R$layout.notification_info, (ViewGroup) null, false), C0006R$drawable.ic_settings);
    }

    static NotificationMenuItem createInfoItem(Context context, boolean z) {
        int i;
        String string = context.getResources().getString(C0014R$string.notification_menu_gear_description);
        NotificationInfo notificationInfo = (NotificationInfo) LayoutInflater.from(context).inflate(C0010R$layout.notification_info, (ViewGroup) null, false);
        if (z) {
            i = C0006R$drawable.ic_notifications_silence;
        } else {
            i = C0006R$drawable.ic_notifications_alert;
        }
    ...
    static NotificationMenuRowPlugin.MenuItem createAppOpsItem(Context context) {
        return new NotificationMenuItem(context, null, (AppOpsInfo) LayoutInflater.from(context).inflate(C0010R$layout.app_ops_info, (ViewGroup) null, false), -1);
    }
