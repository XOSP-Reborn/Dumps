...
public class NotificationSwipeHelper extends SwipeHelper implements NotificationSwipeActionHelper {
    ...
    private final Runnable mFalsingCheck = new Runnable() {
        /* class com.android.systemui.statusbar.notification.stack.NotificationSwipeHelper.AnonymousClass1 */
    ...
    public NotificationSwipeHelper(int i, NotificationCallback notificationCallback, Context context, NotificationMenuRowPlugin.OnMenuEventListener onMenuEventListener) {
        super(i, notificationCallback, context);
