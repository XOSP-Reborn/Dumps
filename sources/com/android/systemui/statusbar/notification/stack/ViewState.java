...
public class ViewState implements Dumpable {
    ...
    private static final AnimatableProperty SCALE_X_PROPERTY = new AnimatableProperty() {
        ...
        public int getAnimationStartTag() {
            return C0007R$id.scale_x_animator_start_value_tag;
        }

        @Override // com.android.systemui.statusbar.notification.AnimatableProperty
        public int getAnimationEndTag() {
            return C0007R$id.scale_x_animator_end_value_tag;
        }

        @Override // com.android.systemui.statusbar.notification.AnimatableProperty
        public int getAnimatorTag() {
            return C0007R$id.scale_x_animator_tag;
        }
    ...
    private static final AnimatableProperty SCALE_Y_PROPERTY = new AnimatableProperty() {
        ...
        @Override // com.android.systemui.statusbar.notification.AnimatableProperty
        public int getAnimationStartTag() {
            return C0007R$id.scale_y_animator_start_value_tag;
        }

        @Override // com.android.systemui.statusbar.notification.AnimatableProperty
        public int getAnimationEndTag() {
            return C0007R$id.scale_y_animator_end_value_tag;
        }

        @Override // com.android.systemui.statusbar.notification.AnimatableProperty
        public int getAnimatorTag() {
            return C0007R$id.scale_y_animator_tag;
        }
    ...
    private static final int TAG_ANIMATOR_ALPHA = C0007R$id.alpha_animator_tag;
    private static final int TAG_ANIMATOR_TRANSLATION_X = C0007R$id.translation_x_animator_tag;
    private static final int TAG_ANIMATOR_TRANSLATION_Y = C0007R$id.translation_y_animator_tag;
    private static final int TAG_ANIMATOR_TRANSLATION_Z = C0007R$id.translation_z_animator_tag;
    private static final int TAG_END_ALPHA = C0007R$id.alpha_animator_end_value_tag;
    private static final int TAG_END_TRANSLATION_X = C0007R$id.translation_x_animator_end_value_tag;
    private static final int TAG_END_TRANSLATION_Y = C0007R$id.translation_y_animator_end_value_tag;
    private static final int TAG_END_TRANSLATION_Z = C0007R$id.translation_z_animator_end_value_tag;
    private static final int TAG_START_ALPHA = C0007R$id.alpha_animator_start_value_tag;
    private static final int TAG_START_TRANSLATION_X = C0007R$id.translation_x_animator_start_value_tag;
    private static final int TAG_START_TRANSLATION_Y = C0007R$id.translation_y_animator_start_value_tag;
    private static final int TAG_START_TRANSLATION_Z = C0007R$id.translation_z_animator_start_value_tag;
    public float alpha;
    public boolean gone;
