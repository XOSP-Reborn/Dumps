    ...
    public class AnimationRunner extends IRemoteAnimationRunner.Stub {
        ...
        public void onAnimationStart(RemoteAnimationTarget[] remoteAnimationTargetArr, IRemoteAnimationFinishedCallback iRemoteAnimationFinishedCallback) throws RemoteException {
            this.mSourceNotification.post(new Runnable(remoteAnimationTargetArr, iRemoteAnimationFinishedCallback) {
                /* class com.android.systemui.statusbar.notification.$$Lambda$ActivityLaunchAnimator$AnimationRunner$sNLXzFzCbt6n0LlixbKU_lp1tVA */
        ...
        public /* synthetic */ void lambda$onAnimationStart$0$ActivityLaunchAnimator$AnimationRunner(RemoteAnimationTarget[] remoteAnimationTargetArr, final IRemoteAnimationFinishedCallback iRemoteAnimationFinishedCallback) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                /* class com.android.systemui.statusbar.notification.ActivityLaunchAnimator.AnimationRunner.AnonymousClass1 */
                ...
                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                    ...
                    expandAnimationParameters.bottom = (int) MathUtils.lerp((float) (AnimationRunner.this.mParams.startPosition[1] + actualHeight), (float) (remoteAnimationTarget.position.y + remoteAnimationTarget.sourceContainerBounds.bottom), interpolation);
            ...
            ofFloat.addListener(new AnimatorListenerAdapter() {
                /* class com.android.systemui.statusbar.notification.ActivityLaunchAnimator.AnimationRunner.AnonymousClass2 */
        ...
        public void onAnimationCancelled() throws RemoteException {
            this.mSourceNotification.post(new Runnable() {
                /* class com.android.systemui.statusbar.notification.$$Lambda$ActivityLaunchAnimator$AnimationRunner$M3NAwVAMqbtd1nWxQdGu3JgCNY */
