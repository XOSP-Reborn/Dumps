...
public class Somnambulator extends Activity {
    public void onStart() {
        ...
        if ("android.intent.action.CREATE_SHORTCUT".equals(intent.getAction())) {
            ...
            intent3.putExtra("android.intent.extra.shortcut.ICON_RESOURCE", Intent.ShortcutIconResource.fromContext(this, C0011R$mipmap.ic_launcher_dreams));
            intent3.putExtra("android.intent.extra.shortcut.INTENT", intent2);
            intent3.putExtra("android.intent.extra.shortcut.NAME", getString(C0014R$string.start_dreams));
            setResult(-1, intent3);
