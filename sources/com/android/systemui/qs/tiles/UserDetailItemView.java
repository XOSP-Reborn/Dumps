...
public class UserDetailItemView extends LinearLayout {
    protected static int layoutResId = C0010R$layout.qs_user_detail_item;
    ...
    public void onFinishInflate() {
        this.mAvatar = (UserAvatarView) findViewById(C0007R$id.user_picture);
        this.mName = (TextView) findViewById(C0007R$id.user_name);
        ...
        updateTypeface();
        this.mRestrictedPadlock = findViewById(C0007R$id.restricted_padlock);
    }

    /* access modifiers changed from: protected */
    public void onConfigurationChanged(Configuration configuration) {
        super.onConfigurationChanged(configuration);
        FontSizeUtils.updateFontSize(this.mName, C0005R$dimen.qs_detail_item_secondary_text_size);
    }
