...
public class NightDisplayTile extends QSTileImpl<QSTile.BooleanState> implements NightDisplayListener.Callback {
    ...
    public void handleClick() {
        ...
        LoggingManager.logQSEvent(this.mContext, "night", "click", Boolean.valueOf(!((QSTile.BooleanState) this.mState).value));
    ...
    public void handleUpdateState(QSTile.BooleanState booleanState, Object obj) {
        ...
        booleanState.label = this.mContext.getString(C0014R$string.quick_settings_night_display_label);
        booleanState.icon = QSTileImpl.ResourceIcon.get(17302786);
    ...
    private String getSecondaryLabel(boolean z) {
        ...
        if (nightDisplayAutoMode == 1) {
            if (z) {
                ...
                i = C0014R$string.quick_settings_secondary_label_until;
            } else {
                localTime = this.mManager.getNightDisplayCustomStartTime();
                i = C0014R$string.quick_settings_night_secondary_label_on_at;
            }
            ...
            if (z) {
                return this.mContext.getString(C0014R$string.quick_settings_night_secondary_label_until_sunrise);
            }
            return this.mContext.getString(C0014R$string.quick_settings_night_secondary_label_on_at_sunset);
        }
    }
    ...
    public CharSequence getTileLabel() {
        return this.mContext.getString(C0014R$string.quick_settings_night_display_label);
    }
