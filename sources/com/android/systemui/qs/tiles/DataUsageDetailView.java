...
public class DataUsageDetailView extends LinearLayout {
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        FontSizeUtils.updateFontSize(this, C0007R$id.usage_text, C0005R$dimen.qs_data_usage_usage_text_size);
        FontSizeUtils.updateFontSize(this, C0007R$id.usage_carrier_text, C0005R$dimen.qs_data_usage_text_size);
        FontSizeUtils.updateFontSize(this, C0007R$id.usage_info_top_text, C0005R$dimen.qs_data_usage_text_size);
        FontSizeUtils.updateFontSize(this, C0007R$id.usage_period_text, C0005R$dimen.qs_data_usage_text_size);
        FontSizeUtils.updateFontSize(this, C0007R$id.usage_info_bottom_text, C0005R$dimen.qs_data_usage_text_size);
    }
