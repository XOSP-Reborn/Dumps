...
public class CastTile extends QSTileImpl<QSTile.BooleanState> {
    ...
    public void handleClick() {
        if (((QSTile.BooleanState) getState()).state != 0) {
            LoggingManager.logQSEvent(this.mContext, "cast", "click", null);
    ...
    public CharSequence getTileLabel() {
        return this.mContext.getString(C0014R$string.quick_settings_cast_title);
    }
    ...
    public void handleUpdateState(QSTile.BooleanState booleanState, Object obj) {
        int i;
        int i2;
        booleanState.label = this.mContext.getString(C0014R$string.quick_settings_cast_title);
        ...
        while (true) {
            ...
            if (i3 == 2) {
                ...
                booleanState.contentDescription = ((Object) booleanState.contentDescription) + "," + this.mContext.getString(C0014R$string.accessibility_cast_name, booleanState.label);
                z = false;
                break;
            } else if (i3 == 1) {
                z = true;
        ...
        if (z && !booleanState.value) {
            booleanState.secondaryLabel = this.mContext.getString(C0014R$string.quick_settings_connecting);
        }
        if (booleanState.value) {
            i2 = C0006R$drawable.ic_cast_connected;
        } else {
            i2 = C0006R$drawable.ic_cast;
        }
        ...
        if (this.mWifiConnected || booleanState.value) {
            ...
            booleanState.contentDescription = ((Object) booleanState.contentDescription) + "," + this.mContext.getString(C0014R$string.accessibility_quick_settings_open_details);
            booleanState.expandedAccessibilityClassName = Button.class.getName();
        } else {
            booleanState.state = 0;
            String string = this.mContext.getString(C0014R$string.quick_settings_cast_no_wifi);
            booleanState.secondaryLabel = string;
            booleanState.contentDescription = ((Object) booleanState.contentDescription) + ", " + this.mContext.getString(C0014R$string.accessibility_quick_settings_not_available, string);
        }
    ...
    public String composeChangeAnnouncement() {
        if (!((QSTile.BooleanState) this.mState).value) {
            return this.mContext.getString(C0014R$string.accessibility_casting_turned_off);
        }
        return null;
    }
    ...
    private String getDeviceName(CastController.CastDevice castDevice) {
        ...
        return str != null ? str : this.mContext.getString(C0014R$string.quick_settings_cast_device_default_name);
    }
    ...
    public final class CastDetailAdapter implements DetailAdapter, QSDetailItems.Callback {
        ...
        public CharSequence getTitle() {
            return ((QSTileImpl) CastTile.this).mContext.getString(C0014R$string.quick_settings_cast_title);
        }
        ...
        public View createDetailView(Context context, View view, ViewGroup viewGroup) {
            ...
            this.mItems.setEmptyState(C0006R$drawable.ic_qs_cast_detail_empty, C0014R$string.quick_settings_cast_detail_empty_text);
                ...
                if (list != null && !list.isEmpty()) {
                    ...
                    while (true) {
                        ...
                        if (next.state == 2) {
                            ...
                            item.line2 = ((QSTileImpl) CastTile.this).mContext.getString(C0014R$string.quick_settings_connected);
                            item.tag = next;
                        ...
                        for (String str : this.mVisibleOrder.keySet()) {
                            ...
                            if (list.contains(castDevice2)) {
                                ...
                                if (castDevice2.state == 1) {
                                    item2.line2 = ((QSTileImpl) CastTile.this).mContext.getString(C0014R$string.quick_settings_connecting);
                                }
