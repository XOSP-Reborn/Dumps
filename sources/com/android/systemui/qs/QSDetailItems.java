...
public class QSDetailItems extends FrameLayout {
    ...
    public static QSDetailItems convertOrInflate(Context context, View view, ViewGroup viewGroup) {
        ...
        return (QSDetailItems) LayoutInflater.from(context).inflate(C0010R$layout.qs_detail_items, viewGroup, false);
    }
    ...
    public void setEmptyState(int i, int i2) {
        this.mEmptyIcon.post(new Runnable(i, i2) {
            /* class com.android.systemui.qs.$$Lambda$QSDetailItems$8UkcDK0xyJROkQ0Pv0OF8HNZO94 */
    ...
    public class Adapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                view = LayoutInflater.from(QSDetailItems.this.mContext).inflate(C0010R$layout.qs_detail_item, viewGroup, false);
            }
