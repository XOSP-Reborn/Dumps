...
public class PageIndicator extends ViewGroup {
    ...
    public void setNumPages(int i) {
        ...
        while (i > getChildCount()) {
            ...
            imageView.setImageResource(C0006R$drawable.minor_a_b);
    ...
    public void setLocation(float f) {
        int i = (int) f;
        int i2 = 0;
        setContentDescription(getContext().getString(C0014R$string.accessibility_quick_settings_page, Integer.valueOf(i + 1), Integer.valueOf(getChildCount())));
        int i3 = i << 1;
        if (f != ((float) i)) {
            i2 = 1;
        }
    ...
    private void setIndex(int i) {
        ...
        while (i2 < childCount) {
            ...
            imageView.setImageResource(C0006R$drawable.major_a_b);
    ...
    private int getTransition(boolean z, boolean z2, boolean z3) {
        if (z3) {
            if (z) {
                if (z2) {
                    return C0006R$drawable.major_b_a_animation;
                }
                return C0006R$drawable.major_b_c_animation;
            } else if (z2) {
                return C0006R$drawable.major_a_b_animation;
            } else {
                return C0006R$drawable.major_c_b_animation;
            }
        } else if (z) {
            if (z2) {
                return C0006R$drawable.minor_b_c_animation;
            }
            return C0006R$drawable.minor_b_a_animation;
        } else if (z2) {
            return C0006R$drawable.minor_c_b_animation;
        } else {
            return C0006R$drawable.minor_a_b_animation;
        }
    }
