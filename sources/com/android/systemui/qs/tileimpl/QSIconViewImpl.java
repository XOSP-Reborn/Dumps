...
public class QSIconViewImpl extends QSIconView {
    ...
    public void lambda$setIcon$0$QSIconViewImpl(ImageView imageView, QSTile.State state, boolean z) {
        ...
        if (!Objects.equals(icon, imageView.getTag(C0007R$id.qs_icon_tag)) || !Objects.equals(state.slash, imageView.getTag(C0007R$id.qs_slash_tag))) {
            ...
            imageView.setTag(C0007R$id.qs_icon_tag, icon);
            imageView.setTag(C0007R$id.qs_slash_tag, state.slash);
