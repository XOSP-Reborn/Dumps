...
public class QSCarrier extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mMobileGroup = findViewById(C0007R$id.mobile_combo);
        this.mMobileSignal = (ImageView) findViewById(C0007R$id.mobile_signal);
        this.mMobileRoaming = (ImageView) findViewById(C0007R$id.mobile_roaming);
        this.mCarrierText = (TextView) findViewById(C0007R$id.qs_carrier_text);
    ...
    public void updateState(QSCarrierGroup.CellSignalState cellSignalState) {
        ...
        if (cellSignalState.visible) {
            ...
            if (cellSignalState.roaming) {
                sb.append(((LinearLayout) this).mContext.getString(C0014R$string.data_connection_roaming));
                sb.append(", ");
            }
    ...
    private boolean hasValidTypeContentDescription(String str) {
        return TextUtils.equals(str, ((LinearLayout) this).mContext.getString(C0014R$string.data_connection_no_internet)) || TextUtils.equals(str, ((LinearLayout) this).mContext.getString(C0014R$string.cell_data_off_content_description)) || TextUtils.equals(str, ((LinearLayout) this).mContext.getString(C0014R$string.not_default_data_content_description));
    }
