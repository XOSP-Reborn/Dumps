...
public class GuestResumeSessionReceiver extends BroadcastReceiver {
    ...
    private static class ResetSessionDialog extends SystemUIDialog implements DialogInterface.OnClickListener {
        ...
        public ResetSessionDialog(Context context, int i) {
            super(context);
            setTitle(context.getString(C0014R$string.guest_wipe_session_title));
            setMessage(context.getString(C0014R$string.guest_wipe_session_message));
            setCanceledOnTouchOutside(false);
            setButton(-2, context.getString(C0014R$string.guest_wipe_session_wipe), this);
            setButton(-1, context.getString(C0014R$string.guest_wipe_session_dontwipe), this);
            this.mUserId = i;
        }
