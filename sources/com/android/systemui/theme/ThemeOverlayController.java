...
public class ThemeOverlayController extends SystemUI {
    ...
    public void start() {
        ...
        this.mThemeManager = new ThemeOverlayManager((OverlayManager) this.mContext.getSystemService(OverlayManager.class), AsyncTask.THREAD_POOL_EXECUTOR, this.mContext.getString(C0014R$string.launcher_overlayable_package), this.mContext.getString(C0014R$string.themepicker_overlayable_package));
