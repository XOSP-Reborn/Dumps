...
public class BubbleFlyoutView extends FrameLayout {
    ...
    public BubbleFlyoutView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(C0010R$layout.bubble_flyout, (ViewGroup) this, true);
        this.mFlyoutTextContainer = (ViewGroup) findViewById(C0007R$id.bubble_flyout_text_container);
        this.mFlyoutText = (TextView) this.mFlyoutTextContainer.findViewById(C0007R$id.bubble_flyout_text);
    ...
    public void showFlyout(CharSequence charSequence, PointF pointF, float f, boolean z, int i, Runnable runnable) {
        ...
        post(new Runnable(pointF, z) {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleFlyoutView$uI0YooPNkhWtu8ItqiYGpHh1GuY */
