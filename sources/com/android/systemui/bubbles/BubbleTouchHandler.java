...
public class BubbleTouchHandler implements View.OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (this.mTouchedView == null) {
            this.mTouchedView = this.mStack.getTargetView(motionEvent);
        }
        ...
        if (actionMasked == 0) {
            ...
            if (equals2 && this.mMovedEnough) {
                ...
                this.mStack.magnetToStackIfNeededThenAnimateDismissal(this.mTouchedView, xVelocity, yVelocity, new Runnable(equals, str) {
                    /* class com.android.systemui.bubbles.$$Lambda$BubbleTouchHandler$CRI1SYVVWTk0CE6JELaYKVCSdCI */
            ...
            boolean isInDismissTarget = this.mStack.isInDismissTarget(motionEvent);
