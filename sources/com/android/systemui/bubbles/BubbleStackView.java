...
public class BubbleStackView extends FrameLayout {
    ...
    public BubbleStackView(Context context, BubbleData bubbleData, SurfaceSynchronizer surfaceSynchronizer) {
        ...
        this.mBubblePadding = resources.getDimensionPixelSize(C0005R$dimen.bubble_padding);
        this.mExpandedAnimateXDistance = resources.getDimensionPixelSize(C0005R$dimen.bubble_expanded_animate_x_distance);
        this.mExpandedAnimateYDistance = resources.getDimensionPixelSize(C0005R$dimen.bubble_expanded_animate_y_distance);
        ...
        this.mPipDismissHeight = ((FrameLayout) this).mContext.getResources().getDimensionPixelSize(C0005R$dimen.pip_dismiss_gradient_height);
        ...
        this.mDismissContainer.setLayoutParams(new FrameLayout.LayoutParams(-1, getResources().getDimensionPixelSize(C0005R$dimen.pip_dismiss_gradient_height), 80));
        ...
        this.mExpandedViewYAnim.addEndListener(new DynamicAnimation.OnAnimationEndListener() {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$pASZEuVtfFyoFF2s4CpK8srlzg */
        ...
        setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$JEhiIzPncR72OLevX_9noDIsyDo */
        ...
        this.mMoveStackToValidPositionOnLayoutListener = new View.OnLayoutChangeListener() {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$Aj3gHezTKlWCOgQ9WHdTc3f68g */
        ...
        this.mDesaturateAndDarkenAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(colorMatrix, colorMatrix2) {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$tnt8Bxa6ByT59tOoVlsMSNUULw */
    ...
    public void onInitializeAccessibilityNodeInfoInternal(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_top_left, getContext().getResources().getString(C0014R$string.bubble_accessibility_action_move_top_left)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_top_right, getContext().getResources().getString(C0014R$string.bubble_accessibility_action_move_top_right)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_bottom_left, getContext().getResources().getString(C0014R$string.bubble_accessibility_action_move_bottom_left)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_bottom_right, getContext().getResources().getString(C0014R$string.bubble_accessibility_action_move_bottom_right)));
    ...
    public void updateContentDescription() {
        if (!this.mBubbleData.getBubbles().isEmpty()) {
            ...
            String string = getResources().getString(C0014R$string.stream_notification);
            if (charSequence != null) {
                string = charSequence.toString();
            }
            int childCount = this.mBubbleContainer.getChildCount() - 1;
            String string2 = getResources().getString(C0014R$string.bubble_content_description_single, string, appName);
            String string3 = getResources().getString(C0014R$string.bubble_content_description_stack, string, appName, Integer.valueOf(childCount));
            if (!this.mIsExpanded) {
                if (childCount > 0) {
    ...
    /* access modifiers changed from: package-private */
    @VisibleForTesting
    public void setExpandedBubble(NotificationEntry notificationEntry) {
        ...
        if (bubble2 == null || !bubble2.equals(bubble)) {
            ...
            if (this.mIsExpanded) {
                ...
                this.mSurfaceSynchronizer.syncSurfaceAndRun(new Runnable(bubble3, bubble) {
                    /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$uJnxgk09vcFuKWQJxhffRq51h7c */
    ...
    public /* synthetic */ void lambda$setSelectedBubble$7$BubbleStackView(Bubble bubble, Bubble bubble2) {
        ...
        if (bubble2 == null) {
            ...
            notificationEntry = bubble2.entry;
        }
        notifyExpansionChanged(notificationEntry, true);
    }
    ...
    private void animateExpansion(boolean z) {
        ...
        if (this.mIsExpanded != z) {
            ...
            $$Lambda$BubbleStackView$5c3dXYvEqr4qSSbPrW_SOEdPjE r0 = new Runnable() {
                /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$5c3dXYvEqr4qSSbPrW_SOEdPjE */
            ...
            if (z) {
                ...
                this.mExpandedAnimationController.expandFromStack(new Runnable(r0) {
                    /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$bBpXql1jQreadH9xO4XoCcx6O7I */
                ...
                this.mExpandedAnimationController.collapseBackToStack(this.mStackAnimationController.getStackPositionAlongNearestHorizontalEdge(), new Runnable(r0) {
                    /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$amDiwHiDmLFSSxsce9OtjezhNY4 */
                    private final /* synthetic */ Runnable f$1;
    ...
    public void animateMagnetToDismissTarget(View view, boolean z, float f, float f2, float f3, float f4) {
        ...
        if (z) {
            ...
            $$Lambda$BubbleStackView$oLhNqxGbPa3FqJeraIwHlBcS7tk r6 = new Runnable() {
                /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$oLhNqxGbPa3FqJeraIwHlBcS7tk */
    ...
    public void magnetToStackIfNeededThenAnimateDismissal(View view, float f, float f2, Runnable runnable) {
        $$Lambda$BubbleStackView$wNBb9TcVorXyGaagZMMDs0nXEJw r1 = new Runnable(view, runnable, this.mExpandedAnimationController.getDraggedOutBubble()) {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$wNBb9TcVorXyGaagZMMDs0nXEJw */
    ...
    public /* synthetic */ void lambda$magnetToStackIfNeededThenAnimateDismissal$14$BubbleStackView(View view, Runnable runnable, View view2) {
        ...
        if (view == this) {
            this.mStackAnimationController.implodeStack(new Runnable(runnable) {
                /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$e34XM71IP6gJFzDCLRuPf64iTJU */
                private final /* synthetic */ Runnable f$1;
            ...
            this.mExpandedAnimationController.dismissDraggedOutBubble(view2, new Runnable(runnable) {
                /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$6IgSc7nWF13kFj8_shFyg558sU */
                private final /* synthetic */ Runnable f$1;
    ...
    public void animateInFlyoutForBubble(Bubble bubble) {
        CharSequence updateMessage = bubble.entry.getUpdateMessage(getContext());
        if (updateMessage != null && !isExpanded() && !this.mIsExpansionAnimating && !this.mIsGestureInProgress && !this.mSuppressFlyout) {
            ...
            if (bubbleView != null) {
                ...
                this.mAfterFlyoutHides = new Runnable(bubble) {
                    /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$Vnx81abGMMclYnqAiYuaTg3EgOw */
                    private final /* synthetic */ Bubble f$1;
                ...
                post(new Runnable(updateMessage, bubble) {
                    /* class com.android.systemui.bubbles.$$Lambda$BubbleStackView$x4cLoDLloN0oTGF4swiWPoVpuFg */
    ...
    private void updateBubbleShadowsAndDotPosition(boolean z) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            bubbleView.setZ((float) ((getResources().getDimensionPixelSize(C0005R$dimen.bubble_elevation) * 5) - i));
