...
public class ExpandedAnimationController extends PhysicsAnimationLayout.PhysicsAnimationController {
    ...
    private void startOrUpdateExpandAnimation() {
        animationsForChildrenFromIndex(0, new PhysicsAnimationLayout.PhysicsAnimationController.ChildAnimationConfigurator() {
            /* class com.android.systemui.bubbles.animation.$$Lambda$ExpandedAnimationController$_bAKyIb2jwklYUuYKNOzMyBbmlQ */
            ...
            /* class com.android.systemui.bubbles.animation.$$Lambda$ExpandedAnimationController$EZFn_NvDV71tFTo7Iiwoss1HYE */
    ...
    private void startOrUpdateCollapseAnimation() {
        animationsForChildrenFromIndex(0, new PhysicsAnimationLayout.PhysicsAnimationController.ChildAnimationConfigurator(this.mLayout.isFirstChildXLeftOfCenter(this.mCollapsePoint.x) ? -1.0f : 1.0f) {
            /* class com.android.systemui.bubbles.animation.$$Lambda$ExpandedAnimationController$ptlDXRKES6qHH1g5Lesavl1BSOo */
            ...
            /* class com.android.systemui.bubbles.animation.$$Lambda$ExpandedAnimationController$JwqN2wkWyA41gYXti2vwoLMs7Gw */
    ...
    public void onActiveControllerForLayout(PhysicsAnimationLayout physicsAnimationLayout) {
        ...
        this.mBubblePaddingPx = (float) resources.getDimensionPixelSize(C0005R$dimen.bubble_padding);
        this.mBubbleSizePx = (float) resources.getDimensionPixelSize(C0005R$dimen.individual_bubble_size);
        this.mStatusBarHeight = (float) resources.getDimensionPixelSize(17105427);
        this.mPipDismissHeight = (float) resources.getDimensionPixelSize(C0005R$dimen.pip_dismiss_gradient_height);
