...
public class BubbleDismissView extends FrameLayout {
    ...
    private View mDismissGradient = new FrameLayout(((FrameLayout) this).mContext);
    ...
    public BubbleDismissView(Context context) {
        ...
        Drawable drawable = ((FrameLayout) this).mContext.getResources().getDrawable(C0006R$drawable.pip_dismiss_scrim);
        ...
        LayoutInflater.from(context).inflate(C0010R$layout.bubble_dismiss_target, (ViewGroup) this, true);
        this.mDismissTarget = (LinearLayout) findViewById(C0007R$id.bubble_dismiss_icon_container);
        this.mDismissIcon = (ImageView) findViewById(C0007R$id.bubble_dismiss_close_icon);
        this.mDismissText = (TextView) findViewById(C0007R$id.bubble_dismiss_text);
        this.mDismissCircle = findViewById(C0007R$id.bubble_dismiss_circle);
        ...
        this.mDismissTargetAlphaSpring.addEndListener(new DynamicAnimation.OnAnimationEndListener() {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleDismissView$k9Xt4VfLNoRaJ7mqmfivzckWcKM */
    ...
    public void springOut() {
        ...
        this.mDismissGradient.animate().alpha(0.0f).withEndAction(new Runnable() {
            /* class com.android.systemui.bubbles.$$Lambda$BubbleDismissView$OmQt_CNRrZrAdQwJJOztMS1u0Y4 */
