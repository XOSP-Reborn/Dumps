...
public class DumpTruck {
    ...
    public DumpTruck captureHeaps(int[] iArr) {
        ...
        while (i2 < length) {
            ...
            if (i3 == i) {
                String path = new File(file, String.format("heap-%d.ahprof", Integer.valueOf(i3))).getPath();
    ...
    public Intent createShareIntent() {
        ...
        intent.addFlags(1);
        intent.putExtra("android.intent.extra.SUBJECT", String.format("SystemUI memory dump (pss=%dM)", Long.valueOf(this.pss / 1024)));
