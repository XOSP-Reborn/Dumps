...
public class NotificationChannels extends SystemUI {
    ...
    public static void createAll(Context context) {
        ...
        NotificationChannel notificationChannel = new NotificationChannel(BATTERY, context.getString(C0014R$string.notification_channel_battery), 5);
        ...
        notificationManager.createNotificationChannels(Arrays.asList(new NotificationChannel(ALERTS, context.getString(C0014R$string.notification_channel_alerts), 4), new NotificationChannel(GENERAL, context.getString(C0014R$string.notification_channel_general), 1), new NotificationChannel(STORAGE, context.getString(C0014R$string.notification_channel_storage_general), isTv(context) ? 3 : 2), createScreenshotChannel(context.getString(C0014R$string.notification_channel_screenshot), notificationManager.getNotificationChannel(SCREENSHOTS_LEGACY)), notificationChannel, new NotificationChannel(HINTS, context.getString(C0014R$string.notification_channel_hints), 3), new NotificationChannel(UMS, context.getString(C0014R$string.notification_channel_storage_alerts), 3)));
        notificationManager.deleteNotificationChannel(SCREENSHOTS_LEGACY);
        if (isTv(context)) {
            notificationManager.createNotificationChannel(new NotificationChannel(TVPIP, context.getString(C0014R$string.notification_channel_tv_pip), 5));
        }
    }
