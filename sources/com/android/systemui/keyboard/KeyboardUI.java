...
public class KeyboardUI extends SystemUI implements InputManager.OnTabletModeChangedListener {
    ...
    private void init() {
        ...
        this.mKeyboardName = context.getString(17039799);
    ...
    public final class KeyboardUIHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (i != 8) {
                ...
                KeyboardUI.this.mDialog.setTitle(C0014R$string.enable_bluetooth_title);
                KeyboardUI.this.mDialog.setMessage(C0014R$string.enable_bluetooth_message);
                KeyboardUI.this.mDialog.setPositiveButton(C0014R$string.enable_bluetooth_confirmation_ok, bluetoothDialogClickListener);
