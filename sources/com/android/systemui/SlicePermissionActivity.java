...
public class SlicePermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            AlertDialog create = new AlertDialog.Builder(this).setTitle(getString(C0014R$string.slice_permission_title, new Object[]{unicodeWrap, unicodeWrap2})).setView(C0010R$layout.slice_permission_request).setNegativeButton(C0014R$string.slice_permission_deny, this).setPositiveButton(C0014R$string.slice_permission_allow, this).setOnDismissListener(this).create();
            create.getWindow().addSystemFlags(524288);
            create.show();
            ((TextView) create.getWindow().getDecorView().findViewById(C0007R$id.text1)).setText(getString(C0014R$string.slice_permission_text_1, new Object[]{unicodeWrap2}));
            ((TextView) create.getWindow().getDecorView().findViewById(C0007R$id.text2)).setText(getString(C0014R$string.slice_permission_text_2, new Object[]{unicodeWrap2}));
            this.mAllCheckbox = (CheckBox) create.getWindow().getDecorView().findViewById(C0007R$id.slice_permission_checkbox);
            this.mAllCheckbox.setText(getString(C0014R$string.slice_permission_checkbox, new Object[]{unicodeWrap}));
