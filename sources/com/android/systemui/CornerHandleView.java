...
public class CornerHandleView extends View {
    ...
    private float getOuterRadiusPx() {
        int dimensionPixelSize = getResources().getDimensionPixelSize(17105406);
        if (dimensionPixelSize == 0) {
            dimensionPixelSize = getResources().getDimensionPixelSize(17105405);
        }
        if (dimensionPixelSize == 0) {
            dimensionPixelSize = getResources().getDimensionPixelSize(17105407);
        }
        if (dimensionPixelSize == 0) {
