...
public class PipMediaController {
    ...
    private void createMediaActions() {
        String string = this.mContext.getString(C0014R$string.pip_pause);
        ...
        String string2 = this.mContext.getString(C0014R$string.pip_play);
        ...
        String string3 = this.mContext.getString(C0014R$string.pip_skip_to_next);
        ...
        String string4 = this.mContext.getString(C0014R$string.pip_skip_to_prev);
