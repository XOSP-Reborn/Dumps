...
public class PipTouchHandler {
    ...
    private PipTouchGesture mDefaultMovementGesture = new PipTouchGesture() {
        /* class com.android.systemui.pip.phone.PipTouchHandler.AnonymousClass3 */
                ...
                if (pipTouchState.isDragging()) {
                    ...
                    if (PipTouchHandler.this.mMenuState != 0) {
                        ...
                        r12 = new AnimatorListenerAdapter() {
                            /* class com.android.systemui.pip.phone.PipTouchHandler.AnonymousClass3.AnonymousClass1 */
    ...
    private ValueAnimator.AnimatorUpdateListener mUpdateScrimListener = new ValueAnimator.AnimatorUpdateListener() {
        /* class com.android.systemui.pip.phone.PipTouchHandler.AnonymousClass2 */
    ...
    public PipTouchHandler(Context context, IActivityManager iActivityManager, IActivityTaskManager iActivityTaskManager, PipMenuActivityController pipMenuActivityController, InputConsumerController inputConsumerController) {
        ...
        this.mEnableDimissDragToEdge = resources.getBoolean(C0003R$bool.config_pipEnableDismissDragToEdge);
