...
public class PipControlButtonView extends RelativeLayout {
    ...
    public PipControlButtonView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        ((LayoutInflater) getContext().getSystemService("layout_inflater")).inflate(C0010R$layout.tv_pip_control_button, this);
        this.mIconImageView = (ImageView) findViewById(C0007R$id.icon);
        this.mButtonImageView = (ImageView) findViewById(C0007R$id.button);
        this.mDescriptionTextView = (TextView) findViewById(C0007R$id.desc);
    ...
    public void onFinishInflate() {
        ...
        this.mTextFocusGainAnimator = AnimatorInflater.loadAnimator(getContext(), C0000R$anim.tv_pip_controls_focus_gain_animation);
        this.mTextFocusGainAnimator.setTarget(this.mDescriptionTextView);
        this.mButtonFocusGainAnimator = AnimatorInflater.loadAnimator(getContext(), C0000R$anim.tv_pip_controls_focus_gain_animation);
        this.mButtonFocusGainAnimator.setTarget(this.mButtonImageView);
        this.mTextFocusLossAnimator = AnimatorInflater.loadAnimator(getContext(), C0000R$anim.tv_pip_controls_focus_loss_animation);
        this.mTextFocusLossAnimator.setTarget(this.mDescriptionTextView);
        this.mButtonFocusLossAnimator = AnimatorInflater.loadAnimator(getContext(), C0000R$anim.tv_pip_controls_focus_loss_animation);
