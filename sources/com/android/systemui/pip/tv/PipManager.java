...
public class PipManager implements BasePipManager {
    ...
    public class PinnedStackListener extends IPinnedStackListener.Stub {
        ...
        public void onMovementBoundsChanged(Rect rect, Rect rect2, Rect rect3, boolean z, boolean z2, int i) {
            PipManager.this.mHandler.post(new Runnable(rect2) {
                /* class com.android.systemui.pip.tv.$$Lambda$PipManager$PinnedStackListener$_5G38rv0jyzaZL9eAwuaWlTGU4 */
        ...
        public void onActionsChanged(ParceledListSlice parceledListSlice) {
            ...
            PipManager.this.mHandler.post(new Runnable() {
                /* class com.android.systemui.pip.tv.$$Lambda$PipManager$PinnedStackListener$KRSqnvGtvsFkEwCqcSExZLuYv1k */
    ...
    private void loadConfigurationsAndApply(Configuration configuration) {
        ...
        this.mSettingsPipBounds = Rect.unflattenFromString(resources.getString(C0014R$string.pip_settings_bounds));
        this.mMenuModePipBounds = Rect.unflattenFromString(resources.getString(C0014R$string.pip_menu_bounds));
