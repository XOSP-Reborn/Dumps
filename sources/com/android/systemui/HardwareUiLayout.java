...
public class HardwareUiLayout extends MultiListLayout implements TunerService.Tunable {
    ...
    private final ViewTreeObserver.OnComputeInternalInsetsListener mInsetsListener = new ViewTreeObserver.OnComputeInternalInsetsListener() {
        /* class com.android.systemui.$$Lambda$HardwareUiLayout$Wopid983i_OFN_0DzaqL8EnwZHc */
    ...
    public ViewGroup getSeparatedView() {
        return (ViewGroup) findViewById(C0007R$id.separated_button);
    }
    ...
    private int getEdgePadding() {
        return getContext().getResources().getDimensionPixelSize(C0005R$dimen.edge_margin);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        post(new Runnable() {
            /* class com.android.systemui.$$Lambda$HardwareUiLayout$e7QpWmSxwKfxOfM1Q3hNoq7i9r0 */
        ...
        post(new Runnable() {
            /* class com.android.systemui.$$Lambda$HardwareUiLayout$zQ_qVVlFo_33izIMpEk2X8p8Su8 */
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        post(new Runnable() {
            /* class com.android.systemui.$$Lambda$HardwareUiLayout$cC2dRGmOoAkRlNqsTu1n43qy3A */
    ...
    public void lambda$onMeasure$1$HardwareUiLayout() {
        ...
        if (this.mList != null) {
            ...
            int[] iArr = this.mTmp2;
            int i2 = (int) (((float) iArr[i]) + f);
            this.mList.getLocationOnScreen(iArr);
            setCutPoint(i2 - this.mTmp2[i]);
        }
    }
    ...
    private float getAnimationDistance() {
        return getContext().getResources().getDimension(C0005R$dimen.global_actions_panel_width) / 2.0f;
    }
