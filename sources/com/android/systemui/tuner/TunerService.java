...
public abstract class TunerService {
    ...
    public static final void showResetRequest(final Context context, final Runnable runnable) {
        ...
        systemUIDialog.setMessage(C0014R$string.remove_from_settings_prompt);
        systemUIDialog.setButton(-2, context.getString(C0014R$string.cancel), (DialogInterface.OnClickListener) null);
        systemUIDialog.setButton(-1, context.getString(C0014R$string.guest_exit_guest_dialog_remove), new DialogInterface.OnClickListener() {
