...
public class NavBarTuner extends TunerPreferenceFragment {
    private static final int[][] ICONS = {new int[]{C0006R$drawable.ic_qs_circle, C0014R$string.tuner_circle}, new int[]{C0006R$drawable.ic_add, C0014R$string.tuner_plus}, new int[]{C0006R$drawable.ic_remove, C0014R$string.tuner_minus}, new int[]{C0006R$drawable.ic_left, C0014R$string.tuner_left}, new int[]{C0006R$drawable.ic_right, C0014R$string.tuner_right}, new int[]{C0006R$drawable.ic_menu, C0014R$string.tuner_menu}};
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        addPreferencesFromResource(C0016R$xml.nav_bar_tuner);
