...
public class PluginFragment extends PreferenceFragment {
    ...
    public static class PluginPreference extends SwitchPreference {
        ...
        public PluginPreference(Context context, PackageInfo packageInfo, PluginEnabler pluginEnabler) {
            ...
            setWidgetLayoutResource(C0010R$layout.tuner_widget_settings_switch);
        }
        ...
        public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
            ...
            int i = 0;
            preferenceViewHolder.findViewById(C0007R$id.settings).setVisibility(this.mHasSettings ? 0 : 8);
            View findViewById = preferenceViewHolder.findViewById(C0007R$id.divider);
            if (!this.mHasSettings) {
                i = 8;
            }
            findViewById.setVisibility(i);
            preferenceViewHolder.findViewById(C0007R$id.settings).setOnClickListener(new View.OnClickListener() {
