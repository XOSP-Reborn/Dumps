...
public class TunerActivity extends Activity implements PreferenceFragment.OnPreferenceStartFragmentCallback, PreferenceFragment.OnPreferenceStartScreenCallback {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0010R$layout.tuner_activity);
        Toolbar toolbar = (Toolbar) findViewById(C0007R$id.action_bar);
        if (toolbar != null) {
        ...
        if (getFragmentManager().findFragmentByTag("tuner") == null) {
            ...
            getFragmentManager().beginTransaction().replace(C0007R$id.content_frame, fragment, "tuner").commit();
        }
    }
    ...
    public boolean onPreferenceStartFragment(PreferenceFragment preferenceFragment, Preference preference) {
        try {
            ...
            beginTransaction.replace(C0007R$id.content_frame, fragment);
    ...
    public boolean onPreferenceStartScreen(PreferenceFragment preferenceFragment, PreferenceScreen preferenceScreen) {
        ...
        beginTransaction.replace(C0007R$id.content_frame, subSettingsFragment);
        beginTransaction.addToBackStack("PreferenceFragment");
        beginTransaction.commit();
        return true;
    }
