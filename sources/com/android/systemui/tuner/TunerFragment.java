...
public class TunerFragment extends PreferenceFragment {
    ...
    public void onCreatePreferences(Bundle bundle, String str) {
        addPreferencesFromResource(C0016R$xml.tuner_prefs);
    ...
    public void onResume() {
        super.onResume();
        getActivity().setTitle(C0014R$string.system_ui_tuner);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        menu.add(0, 2, 0, C0014R$string.remove_from_settings);
    }
    ...
    public static class TunerWarningFragment extends DialogFragment {
        public Dialog onCreateDialog(Bundle bundle) {
            return new AlertDialog.Builder(getContext()).setTitle(C0014R$string.tuner_warning_title).setMessage(C0014R$string.tuner_warning).setPositiveButton(C0014R$string.got_it, new DialogInterface.OnClickListener() {
