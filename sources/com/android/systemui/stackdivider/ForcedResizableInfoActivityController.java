...
public class ForcedResizableInfoActivityController {
    ...
    private void activityDismissingDockedStack() {
        Toast.makeText(this.mContext, C0014R$string.dock_non_resizeble_failed_to_dock_text, 0).show();
    }

    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void activityLaunchOnSecondaryDisplayFailed() {
        Toast.makeText(this.mContext, C0014R$string.activity_launch_on_secondary_display_failed_text, 0).show();
    }
