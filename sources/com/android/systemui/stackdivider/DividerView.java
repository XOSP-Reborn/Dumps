...
public class DividerView extends FrameLayout implements View.OnTouchListener, ViewTreeObserver.OnComputeInternalInsetsListener {
        ...
        this.mHandleDelegate = new View.AccessibilityDelegate() {
            ...
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                ...
                if (DividerView.this.isHorizontalDivision()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_full, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_top_full)));
                    if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_70, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_top_70)));
                    }
                    if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_50, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_top_50)));
                    }
                    if (snapAlgorithm.isLastSplitTargetAvailable()) {
                        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_30, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_top_30)));
                    }
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_rb_full, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_bottom_full)));
                    return;
                }
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_full, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_left_full)));
                if (snapAlgorithm.isFirstSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_70, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_left_70)));
                }
                if (snapAlgorithm.showMiddleSplitTargetForAccessibility()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_50, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_left_50)));
                }
                if (snapAlgorithm.isLastSplitTargetAvailable()) {
                    accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_tl_30, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_left_30)));
                }
                accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C0007R$id.action_move_rb_full, ((FrameLayout) DividerView.this).mContext.getString(C0014R$string.accessibility_action_divider_right_full)));
            }

            public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
                DividerSnapAlgorithm.SnapTarget dismissStartTarget;
                int currentPosition = DividerView.this.getCurrentPosition();
                if (i == C0007R$id.action_move_tl_full) {
                    dismissStartTarget = DividerView.this.mSnapAlgorithm.getDismissEndTarget();
                } else if (i == C0007R$id.action_move_tl_70) {
                    dismissStartTarget = DividerView.this.mSnapAlgorithm.getLastSplitTarget();
                } else if (i == C0007R$id.action_move_tl_50) {
                    dismissStartTarget = DividerView.this.mSnapAlgorithm.getMiddleTarget();
                } else if (i == C0007R$id.action_move_tl_30) {
                    dismissStartTarget = DividerView.this.mSnapAlgorithm.getFirstSplitTarget();
                } else {
                    dismissStartTarget = i == C0007R$id.action_move_rb_full ? DividerView.this.mSnapAlgorithm.getDismissStartTarget() : null;
                }
    ...
    public void onFinishInflate() {
        ...
        this.mHandle = (DividerHandleView) findViewById(C0007R$id.docked_divider_handle);
        this.mBackground = findViewById(C0007R$id.docked_divider_background);
        this.mMinimizedShadow = (MinimizedDockShadow) findViewById(C0007R$id.minimized_dock_shadow);
        this.mHandle.setOnTouchListener(this);
        this.mDividerWindowWidth = getResources().getDimensionPixelSize(17105147);
        this.mDividerInsets = getResources().getDimensionPixelSize(17105146);
        ...
        this.mLongPressEntraceAnimDuration = getResources().getInteger(C0008R$integer.long_press_dock_anim_duration);
        this.mGrowRecents = getResources().getBoolean(C0003R$bool.recents_grow_in_multiwindow);
    ...
    private ValueAnimator getFlingAnimator(int i, DividerSnapAlgorithm.SnapTarget snapTarget, final long j) {
        ...
        ofInt.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(z, snapTarget) {
            /* class com.android.systemui.stackdivider.$$Lambda$DividerView$o4c7SI5Mz67OwDjq6n3ndBTEfNk */
        ...
        final $$Lambda$DividerView$fuKXuLmLQTYwkdmcrCKfS4vkKk8 r7 = new Runnable(snapTarget) {
            /* class com.android.systemui.stackdivider.$$Lambda$DividerView$fuKXuLmLQTYwkdmcrCKfS4vkKk8 */
        ...
        final $$Lambda$DividerView$PQ9UBhgXlQLedw0JrRm_JRuZkk r6 = new Runnable() {
            /* class com.android.systemui.stackdivider.$$Lambda$DividerView$PQ9UBhgXlQLedw0JrRm_JRuZkk */
        ...
        ofInt.addListener(new AnimatorListenerAdapter() {
            /* class com.android.systemui.stackdivider.DividerView.AnonymousClass4 */
    ...
    public void resizeStack(int i, int i2, DividerSnapAlgorithm.SnapTarget snapTarget) {
        if (!this.mRemoved) {
            ...
            if (!this.mDockedRect.equals(this.mLastResizeRect) || this.mEntranceAnimationRunning) {
                ...
                windowManagerProxy2.resizeDockedStack(rect, rect2, rect2, this.mOtherTaskRect, null);
            }
        }
    }
    ...
    public void onRecentsDrawn() {
        ...
        if (dividerState.animateAfterRecentsDrawn) {
            ...
            this.mHandler.post(new Runnable(calculatePositionForInsetBounds) {
                /* class com.android.systemui.stackdivider.$$Lambda$DividerView$6QXub7h9g3mZn2yBpbDKCxY_TW4 */
