...
public class DividerHandleView extends View {
    ...
    public DividerHandleView(Context context, AttributeSet attributeSet) {
        ...
        this.mPaint.setColor(getResources().getColor(C0004R$color.docked_divider_handle, null));
        this.mPaint.setAntiAlias(true);
        this.mWidth = getResources().getDimensionPixelSize(C0005R$dimen.docked_divider_handle_width);
        this.mHeight = getResources().getDimensionPixelSize(C0005R$dimen.docked_divider_handle_height);
        int i = this.mWidth;
