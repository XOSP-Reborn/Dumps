...
public class NetworkOverLimitActivity extends Activity {
    public void onCreate(Bundle bundle) {
        ...
        builder.setMessage(C0014R$string.data_usage_disabled_dialog);
        builder.setPositiveButton(17039370, (DialogInterface.OnClickListener) null);
        builder.setNegativeButton(C0014R$string.data_usage_disabled_dialog_enable, new DialogInterface.OnClickListener() {
    ...
    private static int getLimitedDialogTitleForTemplate(NetworkTemplate networkTemplate) {
        if (networkTemplate.getMatchRule() != 1) {
            return C0014R$string.data_usage_disabled_dialog_title;
        }
        return C0014R$string.data_usage_disabled_dialog_mobile_title;
    }
}
