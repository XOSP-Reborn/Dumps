...
public abstract class GlobalActionsLayout extends MultiListLayout {
    ...
    private void setBackgrounds() {
        int color = getResources().getColor(C0004R$color.global_actions_grid_background, null);
        int color2 = getResources().getColor(C0004R$color.global_actions_separated_background, null);
