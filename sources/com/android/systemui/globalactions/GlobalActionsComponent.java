...
public class GlobalActionsComponent extends SystemUI implements CommandQueue.Callbacks, GlobalActions.GlobalActionsManager {
    ...
    public void start() {
        ...
        ExtensionController.ExtensionBuilder newExtension = ((ExtensionController) Dependency.get(ExtensionController.class)).newExtension(GlobalActions.class);
        newExtension.withPlugin(GlobalActions.class);
        newExtension.withDefault(new Supplier() {
            /* class com.android.systemui.globalactions.$$Lambda$GlobalActionsComponent$YD1kfcxpItFZ4AniRUv_gcXk_Mo */
        ...
        newExtension.withCallback(new Consumer() {
            ...
            public final void accept(Object obj) {
                GlobalActionsComponent.lambda$bGplH0pcKhfpL1pOMBpgWKJntvw(GlobalActionsComponent.this, (GlobalActions) obj);
            }
        });
