...
public class UsbContaminantActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C0010R$layout.contaminant_dialog);
        this.mUsbPort = getIntent().getParcelableExtra("port").getUsbPort((UsbManager) getSystemService(UsbManager.class));
        this.mLearnMore = (TextView) findViewById(C0007R$id.learnMore);
        this.mEnableUsb = (TextView) findViewById(C0007R$id.enableUsb);
        this.mGotIt = (TextView) findViewById(C0007R$id.gotIt);
        this.mTitle = (TextView) findViewById(C0007R$id.title);
        this.mMessage = (TextView) findViewById(C0007R$id.message);
        this.mTitle.setText(getString(C0014R$string.usb_contaminant_title));
        this.mMessage.setText(getString(C0014R$string.usb_contaminant_message));
        this.mEnableUsb.setText(getString(C0014R$string.usb_disable_contaminant_detection));
        this.mGotIt.setText(getString(C0014R$string.got_it));
        this.mLearnMore.setText(getString(C0014R$string.learn_more));
    ...
    public void onClick(View view) {
        if (view == this.mEnableUsb) {
            try {
                ...
                Toast.makeText(this, C0014R$string.usb_port_enabled, 0).show();
            } catch (Exception e) {
