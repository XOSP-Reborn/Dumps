...
public class UsbConfirmActivity extends AlertActivity implements DialogInterface.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (usbDevice == null) {
            alertParams.mMessage = getString(C0014R$string.usb_accessory_confirm_prompt, new Object[]{charSequence, this.mAccessory.getDescription()});
            this.mDisconnectedReceiver = new UsbDisconnectedReceiver((Activity) this, this.mAccessory);
        } else {
            alertParams.mMessage = getString(C0014R$string.usb_device_confirm_prompt, new Object[]{charSequence, usbDevice.getProductName()});
