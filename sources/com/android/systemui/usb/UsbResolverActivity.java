...
public class UsbResolverActivity extends ResolverActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        UsbResolverActivity.super.onCreate(bundle, intent2, getResources().getText(17039682), (Intent[]) null, arrayList, true);
        CheckBox checkBox = (CheckBox) findViewById(16908722);
        if (checkBox == null) {
            return;
        }
        if (this.mDevice == null) {
            checkBox.setText(C0014R$string.always_use_accessory);
        } else {
            checkBox.setText(C0014R$string.always_use_device);
        }
    }
