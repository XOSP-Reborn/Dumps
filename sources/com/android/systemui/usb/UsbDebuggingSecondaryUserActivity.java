...
public class UsbDebuggingSecondaryUserActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertParams.mTitle = getString(C0014R$string.usb_debugging_secondary_user_title);
        alertParams.mMessage = getString(C0014R$string.usb_debugging_secondary_user_message);
