...
public class UsbPermissionActivity extends AlertActivity implements DialogInterface.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            if (usbDevice == null) {
                alertParams.mMessage = getString(C0014R$string.usb_accessory_permission_prompt, new Object[]{charSequence, this.mAccessory.getDescription()});
                this.mDisconnectedReceiver = new UsbDisconnectedReceiver((Activity) this, this.mAccessory);
            } else {
                alertParams.mMessage = getString(C0014R$string.usb_device_permission_prompt, new Object[]{charSequence, usbDevice.getProductName()});
            ...
            if (booleanExtra && !(this.mDevice == null && this.mAccessory == null)) {
                ...
                this.mAlwaysUse = (CheckBox) alertParams.mView.findViewById(16908722);
                UsbDevice usbDevice2 = this.mDevice;
                if (usbDevice2 == null) {
                    this.mAlwaysUse.setText(getString(C0014R$string.always_use_accessory, new Object[]{charSequence, this.mAccessory.getDescription()}));
                } else {
                    this.mAlwaysUse.setText(getString(C0014R$string.always_use_device, new Object[]{charSequence, usbDevice2.getProductName()}));
                }
                this.mAlwaysUse.setOnCheckedChangeListener(this);
                this.mClearDefaultHint = (TextView) alertParams.mView.findViewById(16908810);
