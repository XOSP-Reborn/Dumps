    ...
    public void onCreate(Bundle bundle) {
        ...
        if ("http".equals(scheme) || "https".equals(scheme)) {
            ...
            if (charSequence == null || charSequence.length() == 0) {
                alertParams.mTitle = getString(C0014R$string.title_usb_accessory);
            }
            alertParams.mMessage = getString(C0014R$string.usb_accessory_uri_prompt, new Object[]{this.mUri});
            alertParams.mPositiveButtonText = getString(C0014R$string.label_view);
