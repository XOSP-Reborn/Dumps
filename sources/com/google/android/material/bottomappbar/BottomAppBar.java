            ...
            if (findDependentView != null && !ViewCompat.isLaidOut(findDependentView)) {
                ...
                if (findDependentView instanceof FloatingActionButton) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin == 0) {
                        ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin = Math.max(0, bottomAppBar.getResources().getDimensionPixelOffset(R$dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - this.fabContentRect.height()) / 2));
                    }
                }
