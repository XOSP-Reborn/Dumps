...
public class SliceActionView extends FrameLayout implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    public void setAction(SliceActionImpl sliceActionImpl, EventInfo eventInfo, SliceView.OnSliceActionListener onSliceActionListener, int i, SliceActionLoadingListener sliceActionLoadingListener) {
        ...
        if (sliceActionImpl.isDefaultToggle()) {
            Switch r7 = (Switch) LayoutInflater.from(getContext()).inflate(R$layout.abc_slice_switch, (ViewGroup) this, false);
            addView(r7);
            r7.setChecked(sliceActionImpl.isChecked());
            r7.setOnCheckedChangeListener(this);
            r7.setMinimumHeight(this.mImageSize);
            r7.setMinimumWidth(this.mImageSize);
            if (i != -1) {
                ...
                Drawable wrap = DrawableCompat.wrap(r7.getTrackDrawable());
                DrawableCompat.setTintList(wrap, colorStateList);
                r7.setTrackDrawable(wrap);
                ...
                Drawable wrap2 = DrawableCompat.wrap(r7.getThumbDrawable());
                DrawableCompat.setTintList(wrap2, colorStateList2);
                r7.setThumbDrawable(wrap2);
            }
            this.mActionView = r7;
    ...
    public void setLoading(boolean z) {
        ...
        if (z) {
            if (this.mProgressView == null) {
                this.mProgressView = (ProgressBar) LayoutInflater.from(getContext()).inflate(R$layout.abc_slice_progress_view, (ViewGroup) this, false);
