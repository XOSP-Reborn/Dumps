...
public class PathParser {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            float f14 = fArr[5];
            switch (c3) {
                case R$styleable.ConstraintSet_layout_editor_absoluteY:
                case 'a':
                    i3 = 7;
                    i = i3;
                    break;
                case R$styleable.ConstraintSet_layout_goneMarginEnd:
                case 'c':
                    i3 = 6;
                    i = i3;
                    break;
                ...
                case 'V':
                case 'h':
                case androidx.appcompat.R$styleable.AppCompatTheme_windowFixedHeightMajor:
                    i = 1;
                    break;
                case 'L':
                case 'M':
                case androidx.appcompat.R$styleable.AppCompatTheme_panelBackground:
                case 'l':
                case 'm':
                ...
                case 'S':
                case 'q':
                case androidx.appcompat.R$styleable.AppCompatTheme_windowActionBar:
                    i = 4;
                    break;
                case 'Z':
                case androidx.appcompat.R$styleable.AppCompatTheme_windowMinWidthMajor:
                    path.close();
                    path.moveTo(f13, f14);
                    f9 = f13;
                    f11 = f9;
