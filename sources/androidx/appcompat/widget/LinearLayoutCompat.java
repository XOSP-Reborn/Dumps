        ...
        while (i14 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                if (absoluteGravity == 1) {
                    ...
                    i9 = ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + paddingLeft;
                } else {
                ...
                int i16 = i5 + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
                setChildFrame(virtualChildAt, i9, i16 + getLocationOffset(virtualChildAt), measuredWidth, measuredHeight);
                i14 += getChildrenSkipCount(virtualChildAt, i14);
                i5 = i16 + measuredHeight + ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + getNextLocationOffset(virtualChildAt);
                i6 = 1;
                i14 += i6;
            }
            i6 = 1;
